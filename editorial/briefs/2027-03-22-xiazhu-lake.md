...
title: "Xiazhu Lake: crested ibis, reeds, and the boat"
url: /moganshan/xiazhu-lake/
output_file: output/xiazhu-lake.md
guide_file: src/content/guide/moganshan-xiazhu-lake.md
primary_keyword: "xiazhu lake deqing"
secondary_keywords: []
word_target: 1500
...
# BRIEF 064: Xiazhu Lake: crested ibis, reeds, and the boat
...
| Field | Value |
|---|---|
| Slot | 64 of 122, publishes 22 Mar 2027 (Mon) |
| Pillar | P8, Around Deqing |
| Working H1 | Xiazhu Lake: crested ibis, reeds, and the boat |
| URL | `/moganshan/xiazhu-lake/` (default, move it by editing `url` in the draft) |
| Output file | `output/xiazhu-lake.md` |
| Published file | `src/content/guide/moganshan-xiazhu-lake.md` |
| Primary keyword | `xiazhu lake deqing` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-03-22`
...
* [ ] Saved as `output/xiazhu-lake.md`
