...
brief_id: 122
slot: 122
publish_date: 2027-09-12
pillar: P9
pillar_name: "News and dispatches"
title: "A year on Moganshan: what we got wrong"
url: /journal/a-year-on-moganshan/
output_file: output/a-year-on-moganshan.md
guide_file: src/content/guide/journal-a-year-on-moganshan.md
primary_keyword: "moganshan travel guide accuracy"
secondary_keywords: []
word_target: 1800
...
# BRIEF 122: A year on Moganshan: what we got wrong
...
| Field | Value |
|---|---|
| Slot | 122 of 122, publishes 12 Sep 2027 (Sun) |
| Pillar | P9, News and dispatches |
| Working H1 | A year on Moganshan: what we got wrong |
| URL | `/journal/a-year-on-moganshan/` (default, move it by editing `url` in the draft) |
| Output file | `output/a-year-on-moganshan.md` |
| Published file | `src/content/guide/journal-a-year-on-moganshan.md` |
| Primary keyword | `moganshan travel guide accuracy` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-09-12`
...
* [ ] Saved as `output/a-year-on-moganshan.md`
