...
title: "Hecun: 1,600 mu of tea and a cave"
url: /moganshan/villages/hecun/
output_file: output/hecun.md
guide_file: src/content/guide/moganshan-villages-hecun.md
primary_keyword: "hecun moganshan tea"
secondary_keywords: []
word_target: 1400
...
# BRIEF 039: Hecun: 1,600 mu of tea and a cave
...
| Field | Value |
|---|---|
| Slot | 39 of 122, publishes 6 Jan 2027 (Wed) |
| Pillar | P2, Villages and stays |
| Working H1 | Hecun: 1,600 mu of tea and a cave |
| URL | `/moganshan/villages/hecun/` (default, move it by editing `url` in the draft) |
| Output file | `output/hecun.md` |
| Published file | `src/content/guide/moganshan-villages-hecun.md` |
| Primary keyword | `hecun moganshan tea` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-01-06`
