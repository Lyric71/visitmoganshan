...
brief_id: 105
slot: 105
publish_date: 2027-07-23
pillar: P5
pillar_name: "History and culture"
title: "Dressing up: the qipao photo shoot industry"
url: /journal/dressing-up/
output_file: output/dressing-up.md
guide_file: src/content/guide/journal-dressing-up.md
primary_keyword: "moganshan photography"
secondary_keywords: ["qipao photoshoot china"]
word_target: 1300
...
# BRIEF 105: Dressing up: the qipao photo shoot industry
...
| Field | Value |
|---|---|
| Slot | 105 of 122, publishes 23 Jul 2027 (Fri) |
| Pillar | P5, History and culture |
| Working H1 | Dressing up: the qipao photo shoot industry |
| URL | `/journal/dressing-up/` (default, move it by editing `url` in the draft) |
| Output file | `output/dressing-up.md` |
| Published file | `src/content/guide/journal-dressing-up.md` |
| Primary keyword | `moganshan photography` |
| Secondary keywords | `qipao photoshoot china` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-07-23`
...
* [ ] Saved as `output/dressing-up.md`
