...
brief_id: 101
slot: 101
publish_date: 2027-07-11
pillar: P8
pillar_name: "Around Deqing"
title: "Xiangyue Lake: roses, horses and chestnuts"
url: /moganshan/xiangyue-lake/
output_file: output/xiangyue-lake.md
guide_file: src/content/guide/moganshan-xiangyue-lake.md
primary_keyword: "xiangyue lake deqing"
secondary_keywords: []
word_target: 1200
...
# BRIEF 101: Xiangyue Lake: roses, horses and chestnuts
...
| Field | Value |
|---|---|
| Slot | 101 of 122, publishes 11 Jul 2027 (Sun) |
| Pillar | P8, Around Deqing |
| Working H1 | Xiangyue Lake: roses, horses and chestnuts |
| URL | `/moganshan/xiangyue-lake/` (default, move it by editing `url` in the draft) |
| Output file | `output/xiangyue-lake.md` |
| Published file | `src/content/guide/moganshan-xiangyue-lake.md` |
| Primary keyword | `xiangyue lake deqing` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-07-11`
...
* [ ] Saved as `output/xiangyue-lake.md`
