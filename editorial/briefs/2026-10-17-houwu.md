...
title: "Houwu: streams, a thousand-year ginkgo, and the second transfer centre"
url: /moganshan/villages/houwu/
output_file: output/houwu.md
guide_file: src/content/guide/moganshan-villages-houwu.md
primary_keyword: "houwu village moganshan"
secondary_keywords: []
word_target: 1500
affiliate: "go/stays-village-houwu"
author: echo-peng
...
# BRIEF 012: Houwu: streams, a thousand-year ginkgo, and the second transfer centre
...
| Field | Value |
|---|---|
| Slot | 12 of 122, publishes 17 Oct 2026 (Sat) |
| Pillar | P2, Villages and stays |
| Working H1 | Houwu: streams, a thousand-year ginkgo, and the second transfer centre |
| URL | `/moganshan/villages/houwu/` (default, move it by editing `url` in the draft) |
| Output file | `output/houwu.md` |
| Published file | `src/content/guide/moganshan-villages-houwu.md` |
| Primary keyword | `houwu village moganshan` |
| Secondary keywords | none |
| Body length | 1,500 words, body only, within 10 percent |
| Affiliate | `go/stays-village-houwu`, resolved against the /go/ table per `../CLAUDE.md` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2026-10-17`
