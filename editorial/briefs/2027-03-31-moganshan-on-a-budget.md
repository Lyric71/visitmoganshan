...
title: "Moganshan on a budget: the honest cheap version"
url: /itineraries/moganshan-on-a-budget/
output_file: output/moganshan-on-a-budget.md
guide_file: src/content/guide/itineraries-moganshan-on-a-budget.md
primary_keyword: "moganshan budget"
secondary_keywords: ["cheap moganshan trip"]
word_target: 1600
...
# BRIEF 067: Moganshan on a budget: the honest cheap version
...
| Field | Value |
|---|---|
| Slot | 67 of 122, publishes 31 Mar 2027 (Wed) |
| Pillar | P7, Trip design and comparisons |
| Working H1 | Moganshan on a budget: the honest cheap version |
| URL | `/itineraries/moganshan-on-a-budget/` (default, move it by editing `url` in the draft) |
| Output file | `output/moganshan-on-a-budget.md` |
| Published file | `src/content/guide/itineraries-moganshan-on-a-budget.md` |
| Primary keyword | `moganshan budget` |
| Secondary keywords | `cheap moganshan trip` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-03-31`
...
* [ ] Saved as `output/moganshan-on-a-budget.md`
