...
primary_keyword: "moganshan pet friendly"
secondary_keywords: ["dog friendly moganshan"]
word_target: 1200
...
| Primary keyword | `moganshan pet friendly` |
| Secondary keywords | `dog friendly moganshan` |
...
Part 8 of the master plan wanted this slot confirmed by phone (whether the kennel service still runs).
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2026-12-01`
...
* [ ] Saved as `output/moganshan-with-a-dog.md`
