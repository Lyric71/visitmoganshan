...
title: "The private car ban on Moganshan: what 8am to 5.30pm actually means"
url: /plan/private-car-ban-on-moganshan/
output_file: output/private-car-ban-on-moganshan.md
guide_file: src/content/guide/plan-private-car-ban-on-moganshan.md
primary_keyword: "moganshan private car ban"
secondary_keywords: ["can you drive up moganshan"]
word_target: 1600
affiliate: "go/stays-all soft link at foot"
author: cyril-drouin
...
# BRIEF 001: The private car ban on Moganshan: what 8am to 5.30pm actually means
...
| Field | Value |
|---|---|
| Slot | 1 of 122, publishes 14 Sep 2026 (Mon) |
| Pillar | P1, Access and practicals |
| Working H1 | The private car ban on Moganshan: what 8am to 5.30pm actually means |
| URL | `/plan/private-car-ban-on-moganshan/` (default, move it by editing `url` in the draft) |
| Output file | `output/private-car-ban-on-moganshan.md` |
| Published file | `src/content/guide/plan-private-car-ban-on-moganshan.md` |
| Primary keyword | `moganshan private car ban` |
| Secondary keywords | `can you drive up moganshan` |
| Body length | 1,600 words, body only, within 10 percent |
| Affiliate | `go/stays-all soft link at foot`, resolved against the /go/ table per `../CLAUDE.md` |
...
deqing.gov.cn notices; 腾讯 交通管制 pieces; 游侠客 攻略
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2026-09-14`
...
* [ ] Saved as `output/private-car-ban-on-moganshan.md`
