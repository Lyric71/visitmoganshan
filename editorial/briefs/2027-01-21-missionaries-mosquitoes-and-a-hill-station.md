...
title: "Missionaries, mosquitoes and a hill station: how foreigners built Moganshan"
url: /journal/missionaries-mosquitoes-and-a-hill-station/
output_file: output/missionaries-mosquitoes-and-a-hill-station.md
guide_file: src/content/guide/journal-missionaries-mosquitoes-and-a-hill-station.md
primary_keyword: "moganshan history"
secondary_keywords: ["moganshan hill station"]
word_target: 2400
...
# BRIEF 044: Missionaries, mosquitoes and a hill station: how foreigners built Moganshan
...
| Field | Value |
|---|---|
| Slot | 44 of 122, publishes 21 Jan 2027 (Thu) |
| Pillar | P5, History and culture |
| Working H1 | Missionaries, mosquitoes and a hill station: how foreigners built Moganshan |
| URL | `/journal/missionaries-mosquitoes-and-a-hill-station/` (default, move it by editing `url` in the draft) |
| Output file | `output/missionaries-mosquitoes-and-a-hill-station.md` |
| Published file | `src/content/guide/journal-missionaries-mosquitoes-and-a-hill-station.md` |
| Primary keyword | `moganshan history` |
| Secondary keywords | `moganshan hill station` |
| Body length | 2,400 words, body only, within 10 percent |
| Affiliate | none |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-01-21`
...
* [ ] Saved as `output/missionaries-mosquitoes-and-a-hill-station.md`
