...
title: "Moganshan for older travellers"
url: /itineraries/moganshan-for-older-travellers/
output_file: output/moganshan-for-older-travellers.md
guide_file: src/content/guide/itineraries-moganshan-for-older-travellers.md
primary_keyword: "moganshan for seniors"
secondary_keywords: []
word_target: 1400
...
# BRIEF 081: Moganshan for older travellers
...
| Field | Value |
|---|---|
| Slot | 81 of 122, publishes 12 May 2027 (Wed) |
| Pillar | P7, Trip design and comparisons |
| Working H1 | Moganshan for older travellers |
| URL | `/itineraries/moganshan-for-older-travellers/` (default, move it by editing `url` in the draft) |
| Output file | `output/moganshan-for-older-travellers.md` |
| Published file | `src/content/guide/itineraries-moganshan-for-older-travellers.md` |
| Primary keyword | `moganshan for seniors` |
...
60-69 and 70+ ticket concessions
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-05-12`
...
* [ ] Saved as `output/moganshan-for-older-travellers.md`
