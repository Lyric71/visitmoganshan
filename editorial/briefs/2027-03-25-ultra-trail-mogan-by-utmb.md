...
brief_id: 065
slot: 65
publish_date: 2027-03-25
pillar: P3
pillar_name: "Trails and outdoors"
title: "Ultra-Trail Mogan by UTMB: the race, the routes, the weekend"
url: /things-to-do/ultra-trail-mogan-by-utmb/
output_file: output/ultra-trail-mogan-by-utmb.md
guide_file: src/content/guide/things-to-do-ultra-trail-mogan-by-utmb.md
primary_keyword: "utmb moganshan"
secondary_keywords: []
word_target: 1800
...
# BRIEF 065: Ultra-Trail Mogan by UTMB: the race, the routes, the weekend
...
| Field | Value |
|---|---|
| Slot | 65 of 122, publishes 25 Mar 2027 (Thu) |
| Pillar | P3, Trails and outdoors |
| Working H1 | Ultra-Trail Mogan by UTMB: the race, the routes, the weekend |
| URL | `/things-to-do/ultra-trail-mogan-by-utmb/` (default, move it by editing `url` in the draft) |
| Output file | `output/ultra-trail-mogan-by-utmb.md` |
| Published file | `src/content/guide/things-to-do-ultra-trail-mogan-by-utmb.md` |
| Primary keyword | `utmb moganshan` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-03-25`
...
* [ ] Saved as `output/ultra-trail-mogan-by-utmb.md`
