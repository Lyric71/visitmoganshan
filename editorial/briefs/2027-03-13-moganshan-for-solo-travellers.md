...
brief_id: 061
slot: 61
publish_date: 2027-03-13
pillar: P7
pillar_name: "Trip design and comparisons"
title: "Moganshan for solo travellers"
url: /itineraries/moganshan-for-solo-travellers/
output_file: output/moganshan-for-solo-travellers.md
guide_file: src/content/guide/itineraries-moganshan-for-solo-travellers.md
primary_keyword: "moganshan solo travel"
secondary_keywords: []
word_target: 1500
...
# BRIEF 061: Moganshan for solo travellers
...
| Field | Value |
|---|---|
| Slot | 61 of 122, publishes 13 Mar 2027 (Sat) |
| Pillar | P7, Trip design and comparisons |
| Working H1 | Moganshan for solo travellers |
| URL | `/itineraries/moganshan-for-solo-travellers/` (default, move it by editing `url` in the draft) |
| Output file | `output/moganshan-for-solo-travellers.md` |
| Published file | `src/content/guide/itineraries-moganshan-for-solo-travellers.md` |
| Primary keyword | `moganshan solo travel` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-03-13`
...
* [ ] Saved as `output/moganshan-for-solo-travellers.md`
