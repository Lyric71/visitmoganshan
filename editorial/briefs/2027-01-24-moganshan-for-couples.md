...
brief_id: 045
slot: 45
publish_date: 2027-01-24
pillar: P7
pillar_name: "Trip design and comparisons"
title: "Moganshan for couples"
url: /itineraries/moganshan-for-couples/
output_file: output/moganshan-for-couples.md
guide_file: src/content/guide/itineraries-moganshan-for-couples.md
primary_keyword: "moganshan for couples"
secondary_keywords: ["romantic weekend near shanghai"]
word_target: 1600
...
# BRIEF 045: Moganshan for couples
...
| Field | Value |
|---|---|
| Slot | 45 of 122, publishes 24 Jan 2027 (Sun) |
| Pillar | P7, Trip design and comparisons |
| Working H1 | Moganshan for couples |
| URL | `/itineraries/moganshan-for-couples/` (default, move it by editing `url` in the draft) |
| Output file | `output/moganshan-for-couples.md` |
| Published file | `src/content/guide/itineraries-moganshan-for-couples.md` |
| Primary keyword | `moganshan for couples` |
| Secondary keywords | `romantic weekend near shanghai` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-01-24`
...
* [ ] Saved as `output/moganshan-for-couples.md`
