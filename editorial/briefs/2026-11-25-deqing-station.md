...
title: "Deqing station: which exit, which taxi, which bus"
url: /plan/deqing-station/
output_file: output/deqing-station.md
guide_file: src/content/guide/plan-deqing-station.md
primary_keyword: "deqing station moganshan"
secondary_keywords: ["wukang station"]
word_target: 1300
...
# BRIEF 025: Deqing station: which exit, which taxi, which bus
...
| Field | Value |
|---|---|
| Slot | 25 of 122, publishes 25 Nov 2026 (Wed) |
| Pillar | P1, Access and practicals |
| Working H1 | Deqing station: which exit, which taxi, which bus |
| URL | `/plan/deqing-station/` (default, move it by editing `url` in the draft) |
| Output file | `output/deqing-station.md` |
| Published file | `src/content/guide/plan-deqing-station.md` |
| Primary keyword | `deqing station moganshan` |
| Secondary keywords | `wukang station` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2026-11-25`
...
* [ ] Saved as `output/deqing-station.md`
