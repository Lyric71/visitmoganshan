...
title: "Moganshan for remote work: the digital nomad experiment, honestly"
url: /itineraries/moganshan-for-remote-work/
output_file: output/moganshan-for-remote-work.md
guide_file: src/content/guide/itineraries-moganshan-for-remote-work.md
primary_keyword: "digital nomad china"
secondary_keywords: ["moganshan remote work"]
word_target: 1700
...
# BRIEF 088: Moganshan for remote work: the digital nomad experiment, honestly
...
| Field | Value |
|---|---|
| Slot | 88 of 122, publishes 2 Jun 2027 (Wed) |
| Pillar | P7, Trip design and comparisons |
| Working H1 | Moganshan for remote work: the digital nomad experiment, honestly |
| URL | `/itineraries/moganshan-for-remote-work/` (default, move it by editing `url` in the draft) |
| Output file | `output/moganshan-for-remote-work.md` |
| Published file | `src/content/guide/itineraries-moganshan-for-remote-work.md` |
| Primary keyword | `digital nomad china` |
| Secondary keywords | `moganshan remote work` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-06-02`
...
* [ ] Saved as `output/moganshan-for-remote-work.md`
