...
title: "Moganshan with a toddler: stroller routes and the ones to skip"
url: /itineraries/moganshan-with-a-toddler/
output_file: output/moganshan-with-a-toddler.md
guide_file: src/content/guide/itineraries-moganshan-with-a-toddler.md
primary_keyword: "moganshan with toddler"
secondary_keywords: ["stroller friendly"]
word_target: 1300
...
# BRIEF 092: Moganshan with a toddler: stroller routes and the ones to skip
...
| Field | Value |
|---|---|
| Slot | 92 of 122, publishes 14 Jun 2027 (Mon) |
| Pillar | P7, Trip design and comparisons |
| Working H1 | Moganshan with a toddler: stroller routes and the ones to skip |
| URL | `/itineraries/moganshan-with-a-toddler/` (default, move it by editing `url` in the draft) |
| Output file | `output/moganshan-with-a-toddler.md` |
| Published file | `src/content/guide/itineraries-moganshan-with-a-toddler.md` |
| Primary keyword | `moganshan with toddler` |
| Secondary keywords | `stroller friendly` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-06-14`
...
* [ ] Saved as `output/moganshan-with-a-toddler.md`
