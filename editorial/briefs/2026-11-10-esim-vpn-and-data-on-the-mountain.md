...
title: "eSIM, VPN and data on the mountain: what works in the bamboo"
url: /plan/esim-vpn-and-data-on-the-mountain/
output_file: output/esim-vpn-and-data-on-the-mountain.md
guide_file: src/content/guide/plan-esim-vpn-and-data-on-the-mountain.md
primary_keyword: "china esim"
secondary_keywords: ["vpn moganshan"]
word_target: 1400
...
# BRIEF 020: eSIM, VPN and data on the mountain: what works in the bamboo
...
| Field | Value |
|---|---|
| Slot | 20 of 122, publishes 10 Nov 2026 (Tue) |
| Pillar | P1, Access and practicals |
| Working H1 | eSIM, VPN and data on the mountain: what works in the bamboo |
| URL | `/plan/esim-vpn-and-data-on-the-mountain/` (default, move it by editing `url` in the draft) |
| Output file | `output/esim-vpn-and-data-on-the-mountain.md` |
| Published file | `src/content/guide/plan-esim-vpn-and-data-on-the-mountain.md` |
| Primary keyword | `china esim` |
| Secondary keywords | `vpn moganshan` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2026-11-10`
...
* [ ] Saved as `output/esim-vpn-and-data-on-the-mountain.md`
