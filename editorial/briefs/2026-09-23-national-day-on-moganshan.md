...
output_file: output/national-day-on-moganshan.md
guide_file: src/content/guide/seasons-national-day-on-moganshan.md
...
# BRIEF 004: National Day on Moganshan: the crowd calendar, the road closures, and whether to go
...
| Field | Value |
|---|---|
| Slot | 4 of 122, publishes 23 Sep 2026 (Wed) |
| Pillar | P6, Seasons and timing |
| Working H1 | National Day on Moganshan: the crowd calendar, the road closures, and whether to go |
| URL | `/seasons/national-day-on-moganshan/` (default, move it by editing `url` in the draft) |
| Output file | `output/national-day-on-moganshan.md` |
| Published file | `src/content/guide/seasons-national-day-on-moganshan.md` |
| Primary keyword | `moganshan national day` |
| Secondary keywords | `golden week moganshan` |
...
湖州文旅局 holiday stats; 德清发布 holiday programme
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2026-09-23`
...
* [ ] Saved as `output/national-day-on-moganshan.md`
