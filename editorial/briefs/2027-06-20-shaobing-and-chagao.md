...
brief_id: 094
slot: 94
publish_date: 2027-06-20
pillar: P4
pillar_name: "Food, tea and coffee"
title: "Shaobing and chagao: breakfast on the mountain"
url: /things-to-do/shaobing-and-chagao/
output_file: output/shaobing-and-chagao.md
guide_file: src/content/guide/things-to-do-shaobing-and-chagao.md
primary_keyword: "chinese breakfast moganshan"
secondary_keywords: []
word_target: 1000
...
# BRIEF 094: Shaobing and chagao: breakfast on the mountain
...
| Field | Value |
|---|---|
| Slot | 94 of 122, publishes 20 Jun 2027 (Sun) |
| Pillar | P4, Food, tea and coffee |
| Working H1 | Shaobing and chagao: breakfast on the mountain |
| URL | `/things-to-do/shaobing-and-chagao/` (default, move it by editing `url` in the draft) |
| Output file | `output/shaobing-and-chagao.md` |
| Published file | `src/content/guide/things-to-do-shaobing-and-chagao.md` |
| Primary keyword | `chinese breakfast moganshan` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-06-20`
...
* [ ] Saved as `output/shaobing-and-chagao.md`
