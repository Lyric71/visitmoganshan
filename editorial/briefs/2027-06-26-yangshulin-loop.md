...
brief_id: 096
slot: 96
publish_date: 2027-06-26
pillar: P3
pillar_name: "Trails and outdoors"
title: "Yangshulin loop: the flat walk that works with a pushchair"
url: /things-to-do/yangshulin-loop/
output_file: output/yangshulin-loop.md
guide_file: src/content/guide/things-to-do-yangshulin-loop.md
primary_keyword: "moganshan easy walk with kids"
secondary_keywords: []
word_target: 1100
...
# BRIEF 096: Yangshulin loop: the flat walk that works with a pushchair
...
| Field | Value |
|---|---|
| Slot | 96 of 122, publishes 26 Jun 2027 (Sat) |
| Pillar | P3, Trails and outdoors |
| Working H1 | Yangshulin loop: the flat walk that works with a pushchair |
| URL | `/things-to-do/yangshulin-loop/` (default, move it by editing `url` in the draft) |
| Output file | `output/yangshulin-loop.md` |
| Published file | `src/content/guide/things-to-do-yangshulin-loop.md` |
| Primary keyword | `moganshan easy walk with kids` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-06-26`
...
* [ ] Saved as `output/yangshulin-loop.md`
