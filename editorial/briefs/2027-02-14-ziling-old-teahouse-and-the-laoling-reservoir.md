...
brief_id: 052
slot: 52
publish_date: 2027-02-14
pillar: P3
pillar_name: "Trails and outdoors"
title: "Ziling old teahouse and the Laoling reservoir walk"
url: /things-to-do/ziling-old-teahouse-and-the-laoling-reservoir/
output_file: output/ziling-old-teahouse-and-the-laoling-reservoir.md
guide_file: src/content/guide/things-to-do-ziling-old-teahouse-and-the-laoling-reservoir.md
primary_keyword: "ziling moganshan"
secondary_keywords: ["laoling reservoir"]
word_target: 1400
...
# BRIEF 052: Ziling old teahouse and the Laoling reservoir walk
...
| Field | Value |
|---|---|
| Slot | 52 of 122, publishes 14 Feb 2027 (Sun) |
| Pillar | P3, Trails and outdoors |
| Working H1 | Ziling old teahouse and the Laoling reservoir walk |
| URL | `/things-to-do/ziling-old-teahouse-and-the-laoling-reservoir/` (default, move it by editing `url` in the draft) |
| Output file | `output/ziling-old-teahouse-and-the-laoling-reservoir.md` |
| Published file | `src/content/guide/things-to-do-ziling-old-teahouse-and-the-laoling-reservoir.md` |
| Primary keyword | `ziling moganshan` |
| Secondary keywords | `laoling reservoir` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-02-14`
...
* [ ] Saved as `output/ziling-old-teahouse-and-the-laoling-reservoir.md`
