...
title: "Escaping the heat: why Moganshan is 6 to 10 degrees cooler"
url: /seasons/escaping-the-heat/
output_file: output/escaping-the-heat.md
guide_file: src/content/guide/seasons-escaping-the-heat.md
primary_keyword: "moganshan summer"
secondary_keywords: ["escape shanghai heat"]
word_target: 1400
...
# BRIEF 085: Escaping the heat: why Moganshan is 6 to 10 degrees cooler
...
| Field | Value |
|---|---|
| Slot | 85 of 122, publishes 24 May 2027 (Mon) |
| Pillar | P6, Seasons and timing |
| Working H1 | Escaping the heat: why Moganshan is 6 to 10 degrees cooler |
| URL | `/seasons/escaping-the-heat/` (default, move it by editing `url` in the draft) |
| Output file | `output/escaping-the-heat.md` |
| Published file | `src/content/guide/seasons-escaping-the-heat.md` |
| Primary keyword | `moganshan summer` |
| Secondary keywords | `escape shanghai heat` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-05-24`
...
* [ ] Saved as `output/escaping-the-heat.md`
