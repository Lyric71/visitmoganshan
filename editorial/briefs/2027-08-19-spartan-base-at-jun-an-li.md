...
brief_id: 114
slot: 114
publish_date: 2027-08-19
pillar: P3
pillar_name: "Trails and outdoors"
title: "The Spartan base at Jun An Li"
url: /things-to-do/spartan-base-at-jun-an-li/
output_file: output/spartan-base-at-jun-an-li.md
guide_file: src/content/guide/things-to-do-spartan-base-at-jun-an-li.md
primary_keyword: "spartan race china"
secondary_keywords: ["jun an li moganshan"]
word_target: 1400
...
# BRIEF 114: The Spartan base at Jun An Li
...
| Field | Value |
|---|---|
| Slot | 114 of 122, publishes 19 Aug 2027 (Thu) |
| Pillar | P3, Trails and outdoors |
| Working H1 | The Spartan base at Jun An Li |
| URL | `/things-to-do/spartan-base-at-jun-an-li/` (default, move it by editing `url` in the draft) |
| Output file | `output/spartan-base-at-jun-an-li.md` |
| Published file | `src/content/guide/things-to-do-spartan-base-at-jun-an-li.md` |
| Primary keyword | `spartan race china` |
| Secondary keywords | `jun an li moganshan` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-08-19`
...
* [ ] Saved as `output/spartan-base-at-jun-an-li.md`
