...
brief_id: 079
slot: 79
publish_date: 2027-05-06
pillar: P5
pillar_name: "History and culture"
title: "The Republic library at Yucun: 20,000 issues, free entry"
url: /journal/republic-library-at-yucun/
output_file: output/republic-library-at-yucun.md
guide_file: src/content/guide/journal-republic-library-at-yucun.md
primary_keyword: "moganshan republic library"
secondary_keywords: []
word_target: 1100
...
# BRIEF 079: The Republic library at Yucun: 20,000 issues, free entry
...
| Field | Value |
|---|---|
| Slot | 79 of 122, publishes 6 May 2027 (Thu) |
| Pillar | P5, History and culture |
| Working H1 | The Republic library at Yucun: 20,000 issues, free entry |
| URL | `/journal/republic-library-at-yucun/` (default, move it by editing `url` in the draft) |
| Output file | `output/republic-library-at-yucun.md` |
| Published file | `src/content/guide/journal-republic-library-at-yucun.md` |
| Primary keyword | `moganshan republic library` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-05-06`
...
* [ ] Saved as `output/republic-library-at-yucun.md`
