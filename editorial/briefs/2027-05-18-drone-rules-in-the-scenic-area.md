...
title: "Drone rules in the scenic area"
url: /plan/drone-rules-in-the-scenic-area/
output_file: output/drone-rules-in-the-scenic-area.md
guide_file: src/content/guide/plan-drone-rules-in-the-scenic-area.md
primary_keyword: "drone china scenic area"
secondary_keywords: ["moganshan drone"]
word_target: 1000
...
# BRIEF 083: Drone rules in the scenic area
...
| Field | Value |
|---|---|
| Slot | 83 of 122, publishes 18 May 2027 (Tue) |
| Pillar | P1, Access and practicals |
| Working H1 | Drone rules in the scenic area |
| URL | `/plan/drone-rules-in-the-scenic-area/` (default, move it by editing `url` in the draft) |
| Output file | `output/drone-rules-in-the-scenic-area.md` |
| Published file | `src/content/guide/plan-drone-rules-in-the-scenic-area.md` |
| Primary keyword | `drone china scenic area` |
| Secondary keywords | `moganshan drone` |
| Body length | 1,000 words, body only, within 10 percent |
| Affiliate | none |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-05-18`
...
* [ ] Saved as `output/drone-rules-in-the-scenic-area.md`
