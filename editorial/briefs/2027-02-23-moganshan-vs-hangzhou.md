...
title: "Moganshan vs Hangzhou: as a base, as a day trip, as a pairing"
url: /itineraries/moganshan-vs-hangzhou/
output_file: output/moganshan-vs-hangzhou.md
guide_file: src/content/guide/itineraries-moganshan-vs-hangzhou.md
primary_keyword: "moganshan from hangzhou"
secondary_keywords: []
word_target: 1700
...
# BRIEF 055: Moganshan vs Hangzhou: as a base, as a day trip, as a pairing
...
| Field | Value |
|---|---|
| Slot | 55 of 122, publishes 23 Feb 2027 (Tue) |
| Pillar | P7, Trip design and comparisons |
| Working H1 | Moganshan vs Hangzhou: as a base, as a day trip, as a pairing |
| URL | `/itineraries/moganshan-vs-hangzhou/` (default, move it by editing `url` in the draft) |
| Output file | `output/moganshan-vs-hangzhou.md` |
| Published file | `src/content/guide/itineraries-moganshan-vs-hangzhou.md` |
| Primary keyword | `moganshan from hangzhou` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-02-23`
...
* [ ] Saved as `output/moganshan-vs-hangzhou.md`
