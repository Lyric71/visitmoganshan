...
title: "The bamboo shoot season: chunsun, dongsun and what to order"
url: /things-to-do/bamboo-shoot-season/
output_file: output/bamboo-shoot-season.md
guide_file: src/content/guide/things-to-do-bamboo-shoot-season.md
primary_keyword: "bamboo shoots moganshan"
secondary_keywords: ["chinese spring bamboo shoots"]
word_target: 1300
...
# BRIEF 051: The bamboo shoot season: chunsun, dongsun and what to order
...
| Field | Value |
|---|---|
| Slot | 51 of 122, publishes 11 Feb 2027 (Thu) |
| Pillar | P4, Food, tea and coffee |
| Working H1 | The bamboo shoot season: chunsun, dongsun and what to order |
| URL | `/things-to-do/bamboo-shoot-season/` (default, move it by editing `url` in the draft) |
| Output file | `output/bamboo-shoot-season.md` |
| Published file | `src/content/guide/things-to-do-bamboo-shoot-season.md` |
| Primary keyword | `bamboo shoots moganshan` |
| Secondary keywords | `chinese spring bamboo shoots` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-02-11`
...
* [ ] Saved as `output/bamboo-shoot-season.md`
