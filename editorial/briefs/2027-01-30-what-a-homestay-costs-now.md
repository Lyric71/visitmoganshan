...
brief_id: 047
slot: 47
publish_date: 2027-01-30
pillar: P2
pillar_name: "Villages and stays"
title: "What a homestay costs now: the 2025-26 Moganshan shake-out"
url: /where-to-stay/what-a-homestay-costs-now/
output_file: output/what-a-homestay-costs-now.md
guide_file: src/content/guide/where-to-stay-what-a-homestay-costs-now.md
primary_keyword: "moganshan homestay prices"
secondary_keywords: []
word_target: 2100
...
# BRIEF 047: What a homestay costs now: the 2025-26 Moganshan shake-out
...
| Field | Value |
|---|---|
| Slot | 47 of 122, publishes 30 Jan 2027 (Sat) |
| Pillar | P2, Villages and stays |
| Working H1 | What a homestay costs now: the 2025-26 Moganshan shake-out |
| URL | `/where-to-stay/what-a-homestay-costs-now/` (default, move it by editing `url` in the draft) |
| Output file | `output/what-a-homestay-costs-now.md` |
| Published file | `src/content/guide/where-to-stay-what-a-homestay-costs-now.md` |
| Primary keyword | `moganshan homestay prices` |
| Secondary keywords | none |
| Body length | 2,100 words, body only, within 10 percent |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-01-30`
...
* [ ] Saved as `output/what-a-homestay-costs-now.md`
