...
brief_id: 049
slot: 49
publish_date: 2027-02-05
pillar: P7
pillar_name: "Trip design and comparisons"
title: "Moganshan with children: the honest version"
url: /itineraries/moganshan-with-children/
output_file: output/moganshan-with-children.md
guide_file: src/content/guide/itineraries-moganshan-with-children.md
primary_keyword: "moganshan with kids"
secondary_keywords: []
word_target: 1800
...
# BRIEF 049: Moganshan with children: the honest version
...
| Field | Value |
|---|---|
| Slot | 49 of 122, publishes 5 Feb 2027 (Fri) |
| Pillar | P7, Trip design and comparisons |
| Working H1 | Moganshan with children: the honest version |
| URL | `/itineraries/moganshan-with-children/` (default, move it by editing `url` in the draft) |
| Output file | `output/moganshan-with-children.md` |
| Published file | `src/content/guide/itineraries-moganshan-with-children.md` |
| Primary keyword | `moganshan with kids` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-02-05`
...
* [ ] Saved as `output/moganshan-with-children.md`
