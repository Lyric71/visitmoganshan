...
title: "The climbing festival: Moganshan's oldest walking event"
url: /journal/climbing-festival/
output_file: output/climbing-festival.md
guide_file: src/content/guide/journal-climbing-festival.md
primary_keyword: "moganshan climbing festival"
secondary_keywords: []
word_target: 1300
...
# BRIEF 060: The climbing festival: Moganshan's oldest walking event
...
| Field | Value |
|---|---|
| Slot | 60 of 122, publishes 10 Mar 2027 (Wed) |
| Pillar | P9, News and dispatches |
| Working H1 | The climbing festival: Moganshan's oldest walking event |
| URL | `/journal/climbing-festival/` (default, move it by editing `url` in the draft) |
| Output file | `output/climbing-festival.md` |
| Published file | `src/content/guide/journal-climbing-festival.md` |
| Primary keyword | `moganshan climbing festival` |
...
德清新闻网 2026/03/23; deqing.gov.cn
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-03-10`
...
* [ ] Saved as `output/climbing-festival.md`
