...
brief_id: 077
slot: 77
publish_date: 2027-04-30
pillar: P3
pillar_name: "Trails and outdoors"
title: "Rafting season: the three runs and which is which"
url: /things-to-do/rafting-season/
output_file: output/rafting-season.md
guide_file: src/content/guide/things-to-do-rafting-season.md
primary_keyword: "moganshan rafting"
secondary_keywords: ["piaoliu china"]
word_target: 1500
...
# BRIEF 077: Rafting season: the three runs and which is which
...
| Field | Value |
|---|---|
| Slot | 77 of 122, publishes 30 Apr 2027 (Fri) |
| Pillar | P3, Trails and outdoors |
| Working H1 | Rafting season: the three runs and which is which |
| URL | `/things-to-do/rafting-season/` (default, move it by editing `url` in the draft) |
| Output file | `output/rafting-season.md` |
| Published file | `src/content/guide/things-to-do-rafting-season.md` |
| Primary keyword | `moganshan rafting` |
| Secondary keywords | `piaoliu china` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-04-30`
...
* [ ] Saved as `output/rafting-season.md`
