...
brief_id: 054
slot: 54
publish_date: 2027-02-20
pillar: P4
pillar_name: "Food, tea and coffee"
title: "Mogan Huangya picking season: Qingming to Guyu, and where to pick"
url: /things-to-do/mogan-huangya-picking-season/
output_file: output/mogan-huangya-picking-season.md
guide_file: src/content/guide/things-to-do-mogan-huangya-picking-season.md
primary_keyword: "tea picking china"
secondary_keywords: ["moganshan tea season"]
word_target: 1600
...
# BRIEF 054: Mogan Huangya picking season: Qingming to Guyu, and where to pick
...
| Field | Value |
|---|---|
| Slot | 54 of 122, publishes 20 Feb 2027 (Sat) |
| Pillar | P4, Food, tea and coffee |
| Working H1 | Mogan Huangya picking season: Qingming to Guyu, and where to pick |
| URL | `/things-to-do/mogan-huangya-picking-season/` (default, move it by editing `url` in the draft) |
| Output file | `output/mogan-huangya-picking-season.md` |
| Published file | `src/content/guide/things-to-do-mogan-huangya-picking-season.md` |
| Primary keyword | `tea picking china` |
| Secondary keywords | `moganshan tea season` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-02-20`
...
* [ ] Saved as `output/mogan-huangya-picking-season.md`
