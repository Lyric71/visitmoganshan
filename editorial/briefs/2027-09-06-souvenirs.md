...
brief_id: 120
slot: 120
publish_date: 2027-09-06
pillar: P4
pillar_name: "Food, tea and coffee"
title: "Souvenirs: bamboo, tea, and what's actually made here"
url: /things-to-do/souvenirs/
output_file: output/souvenirs.md
guide_file: src/content/guide/things-to-do-souvenirs.md
primary_keyword: "moganshan souvenirs"
secondary_keywords: []
word_target: 1200
...
# BRIEF 120: Souvenirs: bamboo, tea, and what's actually made here
...
| Field | Value |
|---|---|
| Slot | 120 of 122, publishes 6 Sep 2027 (Mon) |
| Pillar | P4, Food, tea and coffee |
| Working H1 | Souvenirs: bamboo, tea, and what's actually made here |
| URL | `/things-to-do/souvenirs/` (default, move it by editing `url` in the draft) |
| Output file | `output/souvenirs.md` |
| Published file | `src/content/guide/things-to-do-souvenirs.md` |
| Primary keyword | `moganshan souvenirs` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-09-06`
