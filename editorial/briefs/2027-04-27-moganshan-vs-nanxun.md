...
title: "Moganshan vs Nanxun: two versions of quiet"
url: /itineraries/moganshan-vs-nanxun/
output_file: output/moganshan-vs-nanxun.md
guide_file: src/content/guide/itineraries-moganshan-vs-nanxun.md
primary_keyword: "moganshan vs nanxun"
secondary_keywords: []
word_target: 1500
...
# BRIEF 076: Moganshan vs Nanxun: two versions of quiet
...
| Field | Value |
|---|---|
| Slot | 76 of 122, publishes 27 Apr 2027 (Tue) |
| Pillar | P7, Trip design and comparisons |
| Working H1 | Moganshan vs Nanxun: two versions of quiet |
| URL | `/itineraries/moganshan-vs-nanxun/` (default, move it by editing `url` in the draft) |
| Output file | `output/moganshan-vs-nanxun.md` |
| Published file | `src/content/guide/itineraries-moganshan-vs-nanxun.md` |
| Primary keyword | `moganshan vs nanxun` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-04-27`
...
* [ ] Saved as `output/moganshan-vs-nanxun.md`
