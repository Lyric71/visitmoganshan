...
title: "Kaiyuan Sembo: the waterpark resort that isn't really Moganshan"
url: /where-to-stay/kaiyuan-sembo/
output_file: output/kaiyuan-sembo.md
guide_file: src/content/guide/where-to-stay-kaiyuan-sembo.md
primary_keyword: "kaiyuan sembo moganshan"
secondary_keywords: []
word_target: 1500
affiliate: "go/stay-kaiyuan-senbo"
author: echo-peng
...
# BRIEF 050: Kaiyuan Sembo: the waterpark resort that isn't really Moganshan
...
| Field | Value |
|---|---|
| Slot | 50 of 122, publishes 8 Feb 2027 (Mon) |
| Pillar | P2, Villages and stays |
| Working H1 | Kaiyuan Sembo: the waterpark resort that isn't really Moganshan |
| URL | `/where-to-stay/kaiyuan-sembo/` (default, move it by editing `url` in the draft) |
| Output file | `output/kaiyuan-sembo.md` |
| Published file | `src/content/guide/where-to-stay-kaiyuan-sembo.md` |
| Primary keyword | `kaiyuan sembo moganshan` |
| Secondary keywords | none |
| Body length | 1,500 words, body only, within 10 percent |
| Affiliate | `go/stay-kaiyuan-senbo`, resolved against the /go/ table per `../CLAUDE.md` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-02-08`
...
* [ ] Saved as `output/kaiyuan-sembo.md`
