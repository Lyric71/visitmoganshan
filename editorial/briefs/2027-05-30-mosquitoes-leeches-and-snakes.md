...
brief_id: 087
slot: 87
publish_date: 2027-05-30
pillar: P1
pillar_name: "Access and practicals"
title: "Mosquitoes, leeches and snakes: what's real, month by month"
url: /plan/mosquitoes-leeches-and-snakes/
output_file: output/mosquitoes-leeches-and-snakes.md
guide_file: src/content/guide/plan-mosquitoes-leeches-and-snakes.md
primary_keyword: "moganshan mosquitoes"
secondary_keywords: ["hiking china insects"]
word_target: 1100
...
# BRIEF 087: Mosquitoes, leeches and snakes: what's real, month by month
...
| Field | Value |
|---|---|
| Slot | 87 of 122, publishes 30 May 2027 (Sun) |
| Pillar | P1, Access and practicals |
| Working H1 | Mosquitoes, leeches and snakes: what's real, month by month |
| URL | `/plan/mosquitoes-leeches-and-snakes/` (default, move it by editing `url` in the draft) |
| Output file | `output/mosquitoes-leeches-and-snakes.md` |
| Published file | `src/content/guide/plan-mosquitoes-leeches-and-snakes.md` |
| Primary keyword | `moganshan mosquitoes` |
| Secondary keywords | `hiking china insects` |
...
花露水 advice in every Chinese guide
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-05-30`
...
* [ ] Saved as `output/mosquitoes-leeches-and-snakes.md`
