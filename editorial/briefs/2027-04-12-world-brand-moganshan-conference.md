...
title: "The World Brand Moganshan Conference: why hotel rooms vanish in May"
url: /journal/world-brand-moganshan-conference/
output_file: output/world-brand-moganshan-conference.md
guide_file: src/content/guide/journal-world-brand-moganshan-conference.md
primary_keyword: "world brand moganshan conference"
secondary_keywords: []
word_target: 1300
...
# BRIEF 071: The World Brand Moganshan Conference: why hotel rooms vanish in May
...
| Field | Value |
|---|---|
| Slot | 71 of 122, publishes 12 Apr 2027 (Mon) |
| Pillar | P9, News and dispatches |
| Working H1 | The World Brand Moganshan Conference: why hotel rooms vanish in May |
| URL | `/journal/world-brand-moganshan-conference/` (default, move it by editing `url` in the draft) |
| Output file | `output/world-brand-moganshan-conference.md` |
| Published file | `src/content/guide/journal-world-brand-moganshan-conference.md` |
| Primary keyword | `world brand moganshan conference` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-04-12`
...
* [ ] Saved as `output/world-brand-moganshan-conference.md`
