...
brief_id: 068
slot: 68
publish_date: 2027-04-03
pillar: P8
pillar_name: "Around Deqing"
title: "Xinshi ancient town: the water town nobody queues for"
url: /moganshan/xinshi-ancient-town/
output_file: output/xinshi-ancient-town.md
guide_file: src/content/guide/moganshan-xinshi-ancient-town.md
primary_keyword: "xinshi ancient town deqing"
secondary_keywords: []
word_target: 1400
...
# BRIEF 068: Xinshi ancient town: the water town nobody queues for
...
| Field | Value |
|---|---|
| Slot | 68 of 122, publishes 3 Apr 2027 (Sat) |
| Pillar | P8, Around Deqing |
| Working H1 | Xinshi ancient town: the water town nobody queues for |
| URL | `/moganshan/xinshi-ancient-town/` (default, move it by editing `url` in the draft) |
| Output file | `output/xinshi-ancient-town.md` |
| Published file | `src/content/guide/moganshan-xinshi-ancient-town.md` |
| Primary keyword | `xinshi ancient town deqing` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-04-03`
...
* [ ] Saved as `output/xinshi-ancient-town.md`
