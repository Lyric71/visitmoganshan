...
title: "Moganshan in one day from Shanghai: is it really viable?"
url: /itineraries/moganshan-in-one-day-from-shanghai/
output_file: output/moganshan-in-one-day-from-shanghai.md
guide_file: src/content/guide/itineraries-moganshan-in-one-day-from-shanghai.md
...
# BRIEF 036: Moganshan in one day from Shanghai: is it really viable?
...
| Field | Value |
|---|---|
| Slot | 36 of 122, publishes 28 Dec 2026 (Mon) |
| Pillar | P7, Trip design and comparisons |
| Working H1 | Moganshan in one day from Shanghai: is it really viable? |
| URL | `/itineraries/moganshan-in-one-day-from-shanghai/` (default, move it by editing `url` in the draft) |
| Output file | `output/moganshan-in-one-day-from-shanghai.md` |
| Published file | `src/content/guide/itineraries-moganshan-in-one-day-from-shanghai.md` |
| Primary keyword | `moganshan day trip from shanghai` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2026-12-28`
...
* [ ] Saved as `output/moganshan-in-one-day-from-shanghai.md`
