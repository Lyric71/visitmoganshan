...
title: "Camping and glamping on Moganshan"
url: /things-to-do/camping-and-glamping-on-moganshan/
output_file: output/camping-and-glamping-on-moganshan.md
guide_file: src/content/guide/things-to-do-camping-and-glamping-on-moganshan.md
primary_keyword: "moganshan camping"
secondary_keywords: ["glamping china"]
word_target: 1700
...
# BRIEF 078: Camping and glamping on Moganshan
...
| Field | Value |
|---|---|
| Slot | 78 of 122, publishes 3 May 2027 (Mon) |
| Pillar | P3, Trails and outdoors |
| Working H1 | Camping and glamping on Moganshan |
| URL | `/things-to-do/camping-and-glamping-on-moganshan/` (default, move it by editing `url` in the draft) |
| Output file | `output/camping-and-glamping-on-moganshan.md` |
| Published file | `src/content/guide/things-to-do-camping-and-glamping-on-moganshan.md` |
| Primary keyword | `moganshan camping` |
| Secondary keywords | `glamping china` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-05-03`
...
* [ ] Saved as `output/camping-and-glamping-on-moganshan.md`
