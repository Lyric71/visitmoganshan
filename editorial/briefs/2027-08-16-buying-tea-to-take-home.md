...
brief_id: 113
slot: 113
publish_date: 2027-08-16
pillar: P4
pillar_name: "Food, tea and coffee"
title: "Buying tea to take home: what's worth carrying"
url: /things-to-do/buying-tea-to-take-home/
output_file: output/buying-tea-to-take-home.md
guide_file: src/content/guide/things-to-do-buying-tea-to-take-home.md
primary_keyword: "buy chinese tea moganshan"
secondary_keywords: []
word_target: 1200
...
# BRIEF 113: Buying tea to take home: what's worth carrying
...
| Field | Value |
|---|---|
| Slot | 113 of 122, publishes 16 Aug 2027 (Mon) |
| Pillar | P4, Food, tea and coffee |
| Working H1 | Buying tea to take home: what's worth carrying |
| URL | `/things-to-do/buying-tea-to-take-home/` (default, move it by editing `url` in the draft) |
| Output file | `output/buying-tea-to-take-home.md` |
| Published file | `src/content/guide/things-to-do-buying-tea-to-take-home.md` |
| Primary keyword | `buy chinese tea moganshan` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-08-16`
...
* [ ] Saved as `output/buying-tea-to-take-home.md`
