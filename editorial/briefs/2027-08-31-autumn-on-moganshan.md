...
title: "Autumn on Moganshan: the connoisseur's month is September"
url: /seasons/autumn-on-moganshan/
output_file: output/autumn-on-moganshan.md
guide_file: src/content/guide/seasons-autumn-on-moganshan.md
primary_keyword: "moganshan september"
secondary_keywords: ["best month moganshan"]
word_target: 1500
...
# BRIEF 118: Autumn on Moganshan: the connoisseur's month is September
...
| Field | Value |
|---|---|
| Slot | 118 of 122, publishes 31 Aug 2027 (Tue) |
| Pillar | P6, Seasons and timing |
| Working H1 | Autumn on Moganshan: the connoisseur's month is September |
| URL | `/seasons/autumn-on-moganshan/` (default, move it by editing `url` in the draft) |
| Output file | `output/autumn-on-moganshan.md` |
| Published file | `src/content/guide/seasons-autumn-on-moganshan.md` |
| Primary keyword | `moganshan september` |
| Secondary keywords | `best month moganshan` |
...
Chinese guides call September the quiet good-weather window
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-08-31`
...
* [ ] Saved as `output/autumn-on-moganshan.md`
