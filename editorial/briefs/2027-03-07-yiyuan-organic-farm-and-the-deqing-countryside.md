...
brief_id: 059
slot: 59
publish_date: 2027-03-07
pillar: P8
pillar_name: "Around Deqing"
title: "Yiyuan Organic Farm and the Deqing countryside"
url: /moganshan/yiyuan-organic-farm-and-the-deqing-countryside/
output_file: output/yiyuan-organic-farm-and-the-deqing-countryside.md
guide_file: src/content/guide/moganshan-yiyuan-organic-farm-and-the-deqing-countryside.md
primary_keyword: "yiyuan organic farm deqing"
secondary_keywords: []
word_target: 1300
...
# BRIEF 059: Yiyuan Organic Farm and the Deqing countryside
...
| Field | Value |
|---|---|
| Slot | 59 of 122, publishes 7 Mar 2027 (Sun) |
| Pillar | P8, Around Deqing |
| Working H1 | Yiyuan Organic Farm and the Deqing countryside |
| URL | `/moganshan/yiyuan-organic-farm-and-the-deqing-countryside/` (default, move it by editing `url` in the draft) |
| Output file | `output/yiyuan-organic-farm-and-the-deqing-countryside.md` |
| Published file | `src/content/guide/moganshan-yiyuan-organic-farm-and-the-deqing-countryside.md` |
| Primary keyword | `yiyuan organic farm deqing` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-03-07`
...
* [ ] Saved as `output/yiyuan-organic-farm-and-the-deqing-countryside.md`
