...
brief_id: 119
slot: 119
publish_date: 2027-09-03
pillar: P1
pillar_name: "Access and practicals"
title: "The Hangzhou-Deqing rail line: what an hour without transfers changes"
url: /plan/hangzhou-deqing-rail-line/
output_file: output/hangzhou-deqing-rail-line.md
guide_file: src/content/guide/plan-hangzhou-deqing-rail-line.md
primary_keyword: "hangzhou deqing rail"
secondary_keywords: ["getting to moganshan 2027"]
word_target: 1600
...
# BRIEF 119: The Hangzhou-Deqing rail line: what an hour without transfers changes
...
| Field | Value |
|---|---|
| Slot | 119 of 122, publishes 3 Sep 2027 (Fri) |
| Pillar | P1, Access and practicals |
| Working H1 | The Hangzhou-Deqing rail line: what an hour without transfers changes |
| URL | `/plan/hangzhou-deqing-rail-line/` (default, move it by editing `url` in the draft) |
| Output file | `output/hangzhou-deqing-rail-line.md` |
| Published file | `src/content/guide/plan-hangzhou-deqing-rail-line.md` |
| Primary keyword | `hangzhou deqing rail` |
| Secondary keywords | `getting to moganshan 2027` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-09-03`
...
* [ ] Saved as `output/hangzhou-deqing-rail-line.md`
