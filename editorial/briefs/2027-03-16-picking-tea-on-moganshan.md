...
title: "Picking tea on Moganshan: the two weeks that matter"
url: /things-to-do/picking-tea-on-moganshan/
output_file: output/picking-tea-on-moganshan.md
guide_file: src/content/guide/things-to-do-picking-tea-on-moganshan.md
primary_keyword: "tea picking experience china"
secondary_keywords: []
word_target: 1600
...
# BRIEF 062: Picking tea on Moganshan: the two weeks that matter
...
| Field | Value |
|---|---|
| Slot | 62 of 122, publishes 16 Mar 2027 (Tue) |
| Pillar | P4, Food, tea and coffee |
| Working H1 | Picking tea on Moganshan: the two weeks that matter |
| URL | `/things-to-do/picking-tea-on-moganshan/` (default, move it by editing `url` in the draft) |
| Output file | `output/picking-tea-on-moganshan.md` |
| Published file | `src/content/guide/things-to-do-picking-tea-on-moganshan.md` |
| Primary keyword | `tea picking experience china` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-03-16`
...
* [ ] Saved as `output/picking-tea-on-moganshan.md`
