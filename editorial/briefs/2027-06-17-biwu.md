...
brief_id: 093
slot: 93
publish_date: 2027-06-17
pillar: P2
pillar_name: "Villages and stays"
title: "Biwu: the hamlet that started the design-homestay wave"
url: /moganshan/villages/biwu/
output_file: output/biwu.md
guide_file: src/content/guide/moganshan-villages-biwu.md
primary_keyword: "biwu moganshan"
secondary_keywords: ["dale zhiye"]
word_target: 1400
affiliate: "go/stays-village-biwu"
author: echo-peng
...
# BRIEF 093: Biwu: the hamlet that started the design-homestay wave
...
| Field | Value |
|---|---|
| Slot | 93 of 122, publishes 17 Jun 2027 (Thu) |
| Pillar | P2, Villages and stays |
| Working H1 | Biwu: the hamlet that started the design-homestay wave |
| URL | `/moganshan/villages/biwu/` (default, move it by editing `url` in the draft) |
| Output file | `output/biwu.md` |
| Published file | `src/content/guide/moganshan-villages-biwu.md` |
| Primary keyword | `biwu moganshan` |
| Secondary keywords | `dale zhiye` |
| Body length | 1,400 words, body only, within 10 percent |
| Affiliate | `go/stays-village-biwu`, resolved against the /go/ table per `../CLAUDE.md` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-06-17`
