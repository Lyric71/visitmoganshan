...
title: "Spring on Moganshan: blossom, shoots, and the first tea"
url: /seasons/spring-on-moganshan/
output_file: output/spring-on-moganshan.md
guide_file: src/content/guide/seasons-spring-on-moganshan.md
primary_keyword: "moganshan spring"
secondary_keywords: []
word_target: 1500
...
# BRIEF 057: Spring on Moganshan: blossom, shoots, and the first tea
...
| Field | Value |
|---|---|
| Slot | 57 of 122, publishes 1 Mar 2027 (Mon) |
| Pillar | P6, Seasons and timing |
| Working H1 | Spring on Moganshan: blossom, shoots, and the first tea |
| URL | `/seasons/spring-on-moganshan/` (default, move it by editing `url` in the draft) |
| Output file | `output/spring-on-moganshan.md` |
| Published file | `src/content/guide/seasons-spring-on-moganshan.md` |
| Primary keyword | `moganshan spring` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-03-01`
...
* [ ] Saved as `output/spring-on-moganshan.md`
