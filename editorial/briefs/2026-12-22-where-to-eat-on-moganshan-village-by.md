...
title: "Where to eat on Moganshan, village by village"
url: /things-to-do/where-to-eat-on-moganshan-village-by/
output_file: output/where-to-eat-on-moganshan-village-by.md
guide_file: src/content/guide/things-to-do-where-to-eat-on-moganshan-village-by.md
primary_keyword: "where to eat moganshan"
secondary_keywords: []
word_target: 2200
...
# BRIEF 034: Where to eat on Moganshan, village by village
...
| Field | Value |
|---|---|
| Slot | 34 of 122, publishes 22 Dec 2026 (Tue) |
| Pillar | P4, Food, tea and coffee |
| Working H1 | Where to eat on Moganshan, village by village |
| URL | `/things-to-do/where-to-eat-on-moganshan-village-by/` (default, move it by editing `url` in the draft) |
| Output file | `output/where-to-eat-on-moganshan-village-by.md` |
| Published file | `src/content/guide/things-to-do-where-to-eat-on-moganshan-village-by.md` |
| Primary keyword | `where to eat moganshan` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2026-12-22`
...
* [ ] Saved as `output/where-to-eat-on-moganshan-village-by.md`
