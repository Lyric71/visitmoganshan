...
brief_id: 107
slot: 107
publish_date: 2027-07-29
pillar: P7
pillar_name: "Trip design and comparisons"
title: "Moganshan vs Zhujiajiao: near and easy, or far and worth it"
url: /itineraries/moganshan-vs-zhujiajiao/
output_file: output/moganshan-vs-zhujiajiao.md
guide_file: src/content/guide/itineraries-moganshan-vs-zhujiajiao.md
primary_keyword: "moganshan vs zhujiajiao"
secondary_keywords: []
word_target: 1400
...
# BRIEF 107: Moganshan vs Zhujiajiao: near and easy, or far and worth it
...
| Field | Value |
|---|---|
| Slot | 107 of 122, publishes 29 Jul 2027 (Thu) |
| Pillar | P7, Trip design and comparisons |
| Working H1 | Moganshan vs Zhujiajiao: near and easy, or far and worth it |
| URL | `/itineraries/moganshan-vs-zhujiajiao/` (default, move it by editing `url` in the draft) |
| Output file | `output/moganshan-vs-zhujiajiao.md` |
| Published file | `src/content/guide/itineraries-moganshan-vs-zhujiajiao.md` |
| Primary keyword | `moganshan vs zhujiajiao` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-07-29`
...
* [ ] Saved as `output/moganshan-vs-zhujiajiao.md`
