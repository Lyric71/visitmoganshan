...
title: "Moganshan red leaves: where the maples are and when they turn"
url: /seasons/moganshan-red-leaves/
output_file: output/moganshan-red-leaves.md
guide_file: src/content/guide/seasons-moganshan-red-leaves.md
primary_keyword: "moganshan autumn"
secondary_keywords: ["moganshan red leaves"]
word_target: 1500
...
# BRIEF 007: Moganshan red leaves: where the maples are and when they turn
...
| Field | Value |
|---|---|
| Slot | 7 of 122, publishes 2 Oct 2026 (Fri) |
| Pillar | P6, Seasons and timing |
| Working H1 | Moganshan red leaves: where the maples are and when they turn |
| URL | `/seasons/moganshan-red-leaves/` (default, move it by editing `url` in the draft) |
| Output file | `output/moganshan-red-leaves.md` |
| Published file | `src/content/guide/seasons-moganshan-red-leaves.md` |
| Primary keyword | `moganshan autumn` |
| Secondary keywords | `moganshan red leaves` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2026-10-02`
...
* [ ] Saved as `output/moganshan-red-leaves.md`
