...
title: "The zhaijidi reform: how villagers were allowed to lease their houses"
url: /journal/zhaijidi-reform/
output_file: output/zhaijidi-reform.md
guide_file: src/content/guide/journal-zhaijidi-reform.md
primary_keyword: "china rural land reform homestay"
secondary_keywords: []
word_target: 2200
...
# BRIEF 095: The zhaijidi reform: how villagers were allowed to lease their houses
...
| Field | Value |
|---|---|
| Slot | 95 of 122, publishes 23 Jun 2027 (Wed) |
| Pillar | P5, History and culture |
| Working H1 | The zhaijidi reform: how villagers were allowed to lease their houses |
| URL | `/journal/zhaijidi-reform/` (default, move it by editing `url` in the draft) |
| Output file | `output/zhaijidi-reform.md` |
| Published file | `src/content/guide/journal-zhaijidi-reform.md` |
| Primary keyword | `china rural land reform homestay` |
...
宅基地改革 coverage; Feeling the Stones
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-06-23`
...
* [ ] Saved as `output/zhaijidi-reform.md`
