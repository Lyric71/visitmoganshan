...
title: "Wusi: the digital village and its quarry coffee"
url: /moganshan/villages/wusi/
output_file: output/wusi.md
guide_file: src/content/guide/moganshan-villages-wusi.md
primary_keyword: "wusi village deqing"
secondary_keywords: []
word_target: 1400
...
# BRIEF 029: Wusi: the digital village and its quarry coffee
...
| Field | Value |
|---|---|
| Slot | 29 of 122, publishes 7 Dec 2026 (Mon) |
| Pillar | P2, Villages and stays |
| Working H1 | Wusi: the digital village and its quarry coffee |
| URL | `/moganshan/villages/wusi/` (default, move it by editing `url` in the draft) |
| Output file | `output/wusi.md` |
| Published file | `src/content/guide/moganshan-villages-wusi.md` |
| Primary keyword | `wusi village deqing` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2026-12-07`
