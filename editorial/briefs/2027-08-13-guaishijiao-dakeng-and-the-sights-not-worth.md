...
brief_id: 112
slot: 112
publish_date: 2027-08-13
pillar: P3
pillar_name: "Trails and outdoors"
title: "Guaishijiao, Dakeng and the sights not worth your afternoon"
url: /things-to-do/guaishijiao-dakeng-and-the-sights-not-worth/
output_file: output/guaishijiao-dakeng-and-the-sights-not-worth.md
guide_file: src/content/guide/things-to-do-guaishijiao-dakeng-and-the-sights-not-worth.md
primary_keyword: "moganshan what to skip"
secondary_keywords: []
word_target: 1300
...
# BRIEF 112: Guaishijiao, Dakeng and the sights not worth your afternoon
...
| Field | Value |
|---|---|
| Slot | 112 of 122, publishes 13 Aug 2027 (Fri) |
| Pillar | P3, Trails and outdoors |
| Working H1 | Guaishijiao, Dakeng and the sights not worth your afternoon |
| URL | `/things-to-do/guaishijiao-dakeng-and-the-sights-not-worth/` (default, move it by editing `url` in the draft) |
| Output file | `output/guaishijiao-dakeng-and-the-sights-not-worth.md` |
| Published file | `src/content/guide/things-to-do-guaishijiao-dakeng-and-the-sights-not-worth.md` |
| Primary keyword | `moganshan what to skip` |
...
当旅网 避坑攻略; unanimous Chinese verdict on 大坑
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-08-13`
...
* [ ] Saved as `output/guaishijiao-dakeng-and-the-sights-not-worth.md`
