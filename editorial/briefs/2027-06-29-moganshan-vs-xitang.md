...
title: "Moganshan vs Xitang"
url: /itineraries/moganshan-vs-xitang/
output_file: output/moganshan-vs-xitang.md
guide_file: src/content/guide/itineraries-moganshan-vs-xitang.md
primary_keyword: "moganshan vs xitang"
secondary_keywords: []
word_target: 1400
...
| Field | Value |
|---|---|
| Slot | 97 of 122, publishes 29 Jun 2027 (Tue) |
| Pillar | P7, Trip design and comparisons |
| Working H1 | Moganshan vs Xitang |
| URL | `/itineraries/moganshan-vs-xitang/` (default, move it by editing `url` in the draft) |
| Output file | `output/moganshan-vs-xitang.md` |
| Published file | `src/content/guide/itineraries-moganshan-vs-xitang.md` |
| Primary keyword | `moganshan vs xitang` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-06-29`
...
* [ ] Saved as `output/moganshan-vs-xitang.md`
