...
brief_id: 063
slot: 63
publish_date: 2027-03-19
pillar: P3
pillar_name: "Trails and outdoors"
title: "Cycling the foreign-flavour loop"
url: /things-to-do/cycling-the-foreign-flavour-loop/
output_file: output/cycling-the-foreign-flavour-loop.md
guide_file: src/content/guide/things-to-do-cycling-the-foreign-flavour-loop.md
primary_keyword: "cycling moganshan"
secondary_keywords: ["moganshan bike"]
word_target: 1600
...
# BRIEF 063: Cycling the foreign-flavour loop
...
| Field | Value |
|---|---|
| Slot | 63 of 122, publishes 19 Mar 2027 (Fri) |
| Pillar | P3, Trails and outdoors |
| Working H1 | Cycling the foreign-flavour loop |
| URL | `/things-to-do/cycling-the-foreign-flavour-loop/` (default, move it by editing `url` in the draft) |
| Output file | `output/cycling-the-foreign-flavour-loop.md` |
| Published file | `src/content/guide/things-to-do-cycling-the-foreign-flavour-loop.md` |
| Primary keyword | `cycling moganshan` |
| Secondary keywords | `moganshan bike` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-03-19`
...
* [ ] Saved as `output/cycling-the-foreign-flavour-loop.md`
