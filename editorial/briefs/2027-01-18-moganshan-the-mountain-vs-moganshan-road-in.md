...
title: "Moganshan the mountain vs Moganshan Road in Shanghai"
url: /itineraries/moganshan-the-mountain-vs-moganshan-road-in/
output_file: output/moganshan-the-mountain-vs-moganshan-road-in.md
guide_file: src/content/guide/itineraries-moganshan-the-mountain-vs-moganshan-road-in.md
primary_keyword: "moganshan road shanghai"
secondary_keywords: ["m50"]
word_target: 1200
...
# BRIEF 043: Moganshan the mountain vs Moganshan Road in Shanghai
...
| Field | Value |
|---|---|
| Slot | 43 of 122, publishes 18 Jan 2027 (Mon) |
| Pillar | P7, Trip design and comparisons |
| Working H1 | Moganshan the mountain vs Moganshan Road in Shanghai |
| URL | `/itineraries/moganshan-the-mountain-vs-moganshan-road-in/` (default, move it by editing `url` in the draft) |
| Output file | `output/moganshan-the-mountain-vs-moganshan-road-in.md` |
| Published file | `src/content/guide/itineraries-moganshan-the-mountain-vs-moganshan-road-in.md` |
| Primary keyword | `moganshan road shanghai` |
| Secondary keywords | `m50` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-01-18`
...
* [ ] Saved as `output/moganshan-the-mountain-vs-moganshan-road-in.md`
