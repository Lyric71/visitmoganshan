...
brief_id: 070
slot: 70
publish_date: 2027-04-09
pillar: P4
pillar_name: "Food, tea and coffee"
title: "Where to get coffee on Moganshan: the full list"
url: /things-to-do/where-to-get-coffee-on-moganshan/
output_file: output/where-to-get-coffee-on-moganshan.md
guide_file: src/content/guide/things-to-do-where-to-get-coffee-on-moganshan.md
primary_keyword: "moganshan coffee"
secondary_keywords: []
word_target: 1800
...
# BRIEF 070: Where to get coffee on Moganshan: the full list
...
| Field | Value |
|---|---|
| Slot | 70 of 122, publishes 9 Apr 2027 (Fri) |
| Pillar | P4, Food, tea and coffee |
| Working H1 | Where to get coffee on Moganshan: the full list |
| URL | `/things-to-do/where-to-get-coffee-on-moganshan/` (default, move it by editing `url` in the draft) |
| Output file | `output/where-to-get-coffee-on-moganshan.md` |
| Published file | `src/content/guide/things-to-do-where-to-get-coffee-on-moganshan.md` |
| Primary keyword | `moganshan coffee` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-04-09`
...
* [ ] Saved as `output/where-to-get-coffee-on-moganshan.md`
