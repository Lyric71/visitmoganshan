...
title: "Booking a Chinese guesthouse from abroad: deposits, cancellations, and the photo gap"
url: /plan/booking-a-chinese-guesthouse-from-abroad/
output_file: output/booking-a-chinese-guesthouse-from-abroad.md
guide_file: src/content/guide/plan-booking-a-chinese-guesthouse-from-abroad.md
primary_keyword: "booking chinese homestay from abroad"
secondary_keywords: []
word_target: 1600
...
# BRIEF 053: Booking a Chinese guesthouse from abroad: deposits, cancellations, and the photo gap
...
| Field | Value |
|---|---|
| Slot | 53 of 122, publishes 17 Feb 2027 (Wed) |
| Pillar | P1, Access and practicals |
| Working H1 | Booking a Chinese guesthouse from abroad: deposits, cancellations, and the photo gap |
| URL | `/plan/booking-a-chinese-guesthouse-from-abroad/` (default, move it by editing `url` in the draft) |
| Output file | `output/booking-a-chinese-guesthouse-from-abroad.md` |
| Published file | `src/content/guide/plan-booking-a-chinese-guesthouse-from-abroad.md` |
| Primary keyword | `booking chinese homestay from abroad` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-02-17`
...
* [ ] Saved as `output/booking-a-chinese-guesthouse-from-abroad.md`
