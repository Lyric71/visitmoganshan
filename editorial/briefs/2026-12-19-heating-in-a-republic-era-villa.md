...
title: "Heating, in a Republic-era villa: which stays are actually warm"
url: /where-to-stay/heating-in-a-republic-era-villa/
output_file: output/heating-in-a-republic-era-villa.md
guide_file: src/content/guide/where-to-stay-heating-in-a-republic-era-villa.md
primary_keyword: "moganshan winter accommodation heating"
secondary_keywords: []
word_target: 1400
affiliate: "go/stays-all + property links"
author: echo-peng
...
# BRIEF 033: Heating, in a Republic-era villa: which stays are actually warm
...
| Field | Value |
|---|---|
| Slot | 33 of 122, publishes 19 Dec 2026 (Sat) |
| Pillar | P2, Villages and stays |
| Working H1 | Heating, in a Republic-era villa: which stays are actually warm |
| URL | `/where-to-stay/heating-in-a-republic-era-villa/` (default, move it by editing `url` in the draft) |
| Output file | `output/heating-in-a-republic-era-villa.md` |
| Published file | `src/content/guide/where-to-stay-heating-in-a-republic-era-villa.md` |
| Primary keyword | `moganshan winter accommodation heating` |
| Secondary keywords | none |
| Body length | 1,400 words, body only, within 10 percent |
| Affiliate | `go/stays-all + property links`, resolved against the /go/ table per `../CLAUDE.md` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2026-12-19`
...
* [ ] Saved as `output/heating-in-a-republic-era-villa.md`
