...
title: "Laoling and Sanjiuwu: where the foreign farmstay began"
url: /moganshan/villages/laoling/
output_file: output/laoling.md
guide_file: src/content/guide/moganshan-villages-laoling.md
primary_keyword: "laoling moganshan"
secondary_keywords: ["sanjiuwu naked retreats"]
word_target: 1700
affiliate: "go/stays-village-laoling"
author: echo-peng
...
# BRIEF 021: Laoling and Sanjiuwu: where the foreign farmstay began
...
| Field | Value |
|---|---|
| Slot | 21 of 122, publishes 13 Nov 2026 (Fri) |
| Pillar | P2, Villages and stays |
| Working H1 | Laoling and Sanjiuwu: where the foreign farmstay began |
| URL | `/moganshan/villages/laoling/` (default, move it by editing `url` in the draft) |
| Output file | `output/laoling.md` |
| Published file | `src/content/guide/moganshan-villages-laoling.md` |
| Primary keyword | `laoling moganshan` |
| Secondary keywords | `sanjiuwu naked retreats` |
| Body length | 1,700 words, body only, within 10 percent |
| Affiliate | `go/stays-village-laoling`, resolved against the /go/ table per `../CLAUDE.md` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2026-11-13`
