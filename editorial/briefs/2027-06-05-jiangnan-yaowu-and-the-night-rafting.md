...
brief_id: 089
slot: 89
publish_date: 2027-06-05
pillar: P8
pillar_name: "Around Deqing"
title: "Jiangnan Yaowu and the night rafting"
url: /moganshan/jiangnan-yaowu-and-the-night-rafting/
output_file: output/jiangnan-yaowu-and-the-night-rafting.md
guide_file: src/content/guide/moganshan-jiangnan-yaowu-and-the-night-rafting.md
primary_keyword: "jiangnan yaowu deqing"
secondary_keywords: []
word_target: 1300
...
# BRIEF 089: Jiangnan Yaowu and the night rafting
...
| Field | Value |
|---|---|
| Slot | 89 of 122, publishes 5 Jun 2027 (Sat) |
| Pillar | P8, Around Deqing |
| Working H1 | Jiangnan Yaowu and the night rafting |
| URL | `/moganshan/jiangnan-yaowu-and-the-night-rafting/` (default, move it by editing `url` in the draft) |
| Output file | `output/jiangnan-yaowu-and-the-night-rafting.md` |
| Published file | `src/content/guide/moganshan-jiangnan-yaowu-and-the-night-rafting.md` |
| Primary keyword | `jiangnan yaowu deqing` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-06-05`
...
* [ ] Saved as `output/jiangnan-yaowu-and-the-night-rafting.md`
