...
title: "Liaoyuan and the 1932 cultural park"
url: /moganshan/villages/liaoyuan/
output_file: output/liaoyuan.md
guide_file: src/content/guide/moganshan-villages-liaoyuan.md
primary_keyword: "liaoyuan village moganshan"
secondary_keywords: ["1932 yucun"]
word_target: 1300
...
# BRIEF 109: Liaoyuan and the 1932 cultural park
...
| Field | Value |
|---|---|
| Slot | 109 of 122, publishes 4 Aug 2027 (Wed) |
| Pillar | P2, Villages and stays |
| Working H1 | Liaoyuan and the 1932 cultural park |
| URL | `/moganshan/villages/liaoyuan/` (default, move it by editing `url` in the draft) |
| Output file | `output/liaoyuan.md` |
| Published file | `src/content/guide/moganshan-villages-liaoyuan.md` |
| Primary keyword | `liaoyuan village moganshan` |
| Secondary keywords | `1932 yucun` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-08-04`
