...
title: "Toilets, water and what to carry on the Moganshan paths"
url: /plan/toilets-water-and-what-to-carry-on/
output_file: output/toilets-water-and-what-to-carry-on.md
guide_file: src/content/guide/plan-toilets-water-and-what-to-carry-on.md
primary_keyword: "moganshan hiking what to bring"
secondary_keywords: []
word_target: 900
...
# BRIEF 074: Toilets, water and what to carry on the Moganshan paths
...
| Field | Value |
|---|---|
| Slot | 74 of 122, publishes 21 Apr 2027 (Wed) |
| Pillar | P1, Access and practicals |
| Working H1 | Toilets, water and what to carry on the Moganshan paths |
| URL | `/plan/toilets-water-and-what-to-carry-on/` (default, move it by editing `url` in the draft) |
| Output file | `output/toilets-water-and-what-to-carry-on.md` |
| Published file | `src/content/guide/plan-toilets-water-and-what-to-carry-on.md` |
| Primary keyword | `moganshan hiking what to bring` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-04-21`
...
* [ ] Saved as `output/toilets-water-and-what-to-carry-on.md`
