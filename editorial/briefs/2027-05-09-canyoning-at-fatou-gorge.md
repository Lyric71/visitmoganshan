...
brief_id: 080
slot: 80
publish_date: 2027-05-09
pillar: P3
pillar_name: "Trails and outdoors"
title: "Canyoning at Fatou gorge: the summer water play locals do"
url: /things-to-do/canyoning-at-fatou-gorge/
output_file: output/canyoning-at-fatou-gorge.md
guide_file: src/content/guide/things-to-do-canyoning-at-fatou-gorge.md
primary_keyword: "moganshan canyoning"
secondary_keywords: ["susi china"]
word_target: 1400
...
# BRIEF 080: Canyoning at Fatou gorge: the summer water play locals do
...
| Field | Value |
|---|---|
| Slot | 80 of 122, publishes 9 May 2027 (Sun) |
| Pillar | P3, Trails and outdoors |
| Working H1 | Canyoning at Fatou gorge: the summer water play locals do |
| URL | `/things-to-do/canyoning-at-fatou-gorge/` (default, move it by editing `url` in the draft) |
| Output file | `output/canyoning-at-fatou-gorge.md` |
| Published file | `src/content/guide/things-to-do-canyoning-at-fatou-gorge.md` |
| Primary keyword | `moganshan canyoning` |
| Secondary keywords | `susi china` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-05-09`
...
* [ ] Saved as `output/canyoning-at-fatou-gorge.md`
