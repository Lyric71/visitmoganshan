...
title: "The rainbow road and the fish-scale weir"
url: /seasons/rainbow-road-and-the-fish-scale-weir/
output_file: output/rainbow-road-and-the-fish-scale-weir.md
guide_file: src/content/guide/seasons-rainbow-road-and-the-fish-scale-weir.md
primary_keyword: "moganshan photo spots"
secondary_keywords: []
word_target: 1200
...
# BRIEF 106: The rainbow road and the fish-scale weir
...
| Field | Value |
|---|---|
| Slot | 106 of 122, publishes 26 Jul 2027 (Mon) |
| Pillar | P6, Seasons and timing |
| Working H1 | The rainbow road and the fish-scale weir |
| URL | `/seasons/rainbow-road-and-the-fish-scale-weir/` (default, move it by editing `url` in the draft) |
| Output file | `output/rainbow-road-and-the-fish-scale-weir.md` |
| Published file | `src/content/guide/seasons-rainbow-road-and-the-fish-scale-weir.md` |
| Primary keyword | `moganshan photo spots` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-07-26`
...
* [ ] Saved as `output/rainbow-road-and-the-fish-scale-weir.md`
