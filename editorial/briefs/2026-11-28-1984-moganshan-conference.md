...
title: "The 1984 Moganshan Conference: the weekend that helped reprice China"
url: /journal/1984-moganshan-conference/
output_file: output/1984-moganshan-conference.md
guide_file: src/content/guide/journal-1984-moganshan-conference.md
primary_keyword: "1984 moganshan conference"
secondary_keywords: []
word_target: 2400
...
# BRIEF 026: The 1984 Moganshan Conference: the weekend that helped reprice China
...
| Field | Value |
|---|---|
| Slot | 26 of 122, publishes 28 Nov 2026 (Sat) |
| Pillar | P5, History and culture |
| Working H1 | The 1984 Moganshan Conference: the weekend that helped reprice China |
| URL | `/journal/1984-moganshan-conference/` (default, move it by editing `url` in the draft) |
| Output file | `output/1984-moganshan-conference.md` |
| Published file | `src/content/guide/journal-1984-moganshan-conference.md` |
| Primary keyword | `1984 moganshan conference` |
...
中国日报 第八届莫干山会议; academic sources
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2026-11-28`
...
* [ ] Saved as `output/1984-moganshan-conference.md`
