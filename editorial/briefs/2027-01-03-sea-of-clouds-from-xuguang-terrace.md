...
title: "Sea of clouds from Xuguang terrace: the 8am gate problem"
url: /seasons/sea-of-clouds-from-xuguang-terrace/
output_file: output/sea-of-clouds-from-xuguang-terrace.md
guide_file: src/content/guide/seasons-sea-of-clouds-from-xuguang-terrace.md
primary_keyword: "moganshan sunrise"
secondary_keywords: ["moganshan cloud sea"]
word_target: 1400
...
# BRIEF 038: Sea of clouds from Xuguang terrace: the 8am gate problem
...
| Field | Value |
|---|---|
| Slot | 38 of 122, publishes 3 Jan 2027 (Sun) |
| Pillar | P6, Seasons and timing |
| Working H1 | Sea of clouds from Xuguang terrace: the 8am gate problem |
| URL | `/seasons/sea-of-clouds-from-xuguang-terrace/` (default, move it by editing `url` in the draft) |
| Output file | `output/sea-of-clouds-from-xuguang-terrace.md` |
| Published file | `src/content/guide/seasons-sea-of-clouds-from-xuguang-terrace.md` |
| Primary keyword | `moganshan sunrise` |
| Secondary keywords | `moganshan cloud sea` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-01-03`
...
* [ ] Saved as `output/sea-of-clouds-from-xuguang-terrace.md`
