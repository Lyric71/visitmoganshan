...
brief_id: 121
slot: 121
publish_date: 2027-09-09
pillar: P8
pillar_name: "Around Deqing"
title: "Shanghai in three days, before or after"
url: /moganshan/shanghai-in-three-days-before-or-after/
output_file: output/shanghai-in-three-days-before-or-after.md
guide_file: src/content/guide/moganshan-shanghai-in-three-days-before-or-after.md
primary_keyword: "shanghai and moganshan itinerary"
secondary_keywords: []
word_target: 1800
affiliate: "go/train-shanghai-deqing"
author: liyan-ye
...
# BRIEF 121: Shanghai in three days, before or after
...
| Field | Value |
|---|---|
| Slot | 121 of 122, publishes 9 Sep 2027 (Thu) |
| Pillar | P8, Around Deqing |
| Working H1 | Shanghai in three days, before or after |
| URL | `/moganshan/shanghai-in-three-days-before-or-after/` (default, move it by editing `url` in the draft) |
| Output file | `output/shanghai-in-three-days-before-or-after.md` |
| Published file | `src/content/guide/moganshan-shanghai-in-three-days-before-or-after.md` |
| Primary keyword | `shanghai and moganshan itinerary` |
| Secondary keywords | none |
| Body length | 1,800 words, body only, within 10 percent |
| Affiliate | `go/train-shanghai-deqing`, resolved against the /go/ table per `../CLAUDE.md` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-09-09`
...
* [ ] Saved as `output/shanghai-in-three-days-before-or-after.md`
