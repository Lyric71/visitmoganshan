...
title: "Star camping and night rides: the summer programme"
url: /seasons/star-camping-and-night-rides/
output_file: output/star-camping-and-night-rides.md
guide_file: src/content/guide/seasons-star-camping-and-night-rides.md
primary_keyword: "moganshan stargazing"
secondary_keywords: ["night activities"]
word_target: 1200
...
# BRIEF 099: Star camping and night rides: the summer programme
...
| Field | Value |
|---|---|
| Slot | 99 of 122, publishes 5 Jul 2027 (Mon) |
| Pillar | P6, Seasons and timing |
| Working H1 | Star camping and night rides: the summer programme |
| URL | `/seasons/star-camping-and-night-rides/` (default, move it by editing `url` in the draft) |
| Output file | `output/star-camping-and-night-rides.md` |
| Published file | `src/content/guide/seasons-star-camping-and-night-rides.md` |
| Primary keyword | `moganshan stargazing` |
| Secondary keywords | `night activities` |
...
800-plus 民宿 night-activity subsidies
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-07-05`
...
* [ ] Saved as `output/star-camping-and-night-rides.md`
