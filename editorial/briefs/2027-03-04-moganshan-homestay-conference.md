...
title: "The Moganshan Homestay Conference: what 1,400 operators are worried about"
url: /journal/moganshan-homestay-conference/
output_file: output/moganshan-homestay-conference.md
guide_file: src/content/guide/journal-moganshan-homestay-conference.md
primary_keyword: "moganshan homestay conference"
secondary_keywords: []
word_target: 1500
...
# BRIEF 058: The Moganshan Homestay Conference: what 1,400 operators are worried about
...
| Field | Value |
|---|---|
| Slot | 58 of 122, publishes 4 Mar 2027 (Thu) |
| Pillar | P9, News and dispatches |
| Working H1 | The Moganshan Homestay Conference: what 1,400 operators are worried about |
| URL | `/journal/moganshan-homestay-conference/` (default, move it by editing `url` in the draft) |
| Output file | `output/moganshan-homestay-conference.md` |
| Published file | `src/content/guide/journal-moganshan-homestay-conference.md` |
| Primary keyword | `moganshan homestay conference` |
...
* [ ] Frontmatter matches the guide schema, `published` and `last_updated` both `2027-03-04`
...
* [ ] Saved as `output/moganshan-homestay-conference.md`
