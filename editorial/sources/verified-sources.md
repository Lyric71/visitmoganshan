...
**Read this before researching anything.** If a figure is here, within its
shelf life and verified twice, reuse the exact citation below. That is what
keeps the same number from appearing three different ways across 174 pieces.

**Append to this file before you finish a draft.** A figure used and not
logged will be researched again in three days.

## How to log an entry

```
### <the figure, in plain words>
* Value: <number and unit, RMB for money>
* As of: <month year the source states, not the date you found it>
* Source: <publisher in English (中文)>
* Tier: <1 to 4, per source-tiers.md>
* URL: <link>
* Verified 1: <date of check 1: page fetched, figure, unit, period and date confirmed>
* Verified 2: <date of check 2: page fetched again before the draft was finished>
* Shelf life: <volatile: 3 months | semi-stable: 6 months | evergreen: 12 months>
* Used in: <slug>, <slug>
* Notes: <anything that limits how it can be used; where sources disagree, log each and say so>
```
...
3. **An OTA is never the source for a price, a closure or a policy.** Tier 4
   entries are logged only as "announced" and say so in Notes.
4. **Disagreement is logged, not resolved.** Where two tier 1 or tier 2
   sources give different figures, both are entries, cross referenced in
   Notes, and the piece publishes the disagreement.
5. **Our own work is logged separately**, in the section below, with the
   method, the date and who did it. It is cited as ours, never as a
   published source.
6. **Recheck anything past its shelf life** before reusing it. Move stale
   entries to the retired section rather than deleting them, so a reader who
   asks where a published number came from can still be answered.

## Prices, tickets, transport (volatile)

<!-- Seed this section from the tier 1 written sources. Nothing from sources/q1-facts-unverified.md moves here without both
checks. -->

### The private car rule: hours and start date
* Value: private vehicles must change to scenic area buses at a transfer station between 08:00 and 17:30 daily; in force since 30 November 2018
* As of: December 2025
* Source: Tide News (潮新闻), reporters 贾晓雯 and 吴煌; republished by Hangzhou Net (杭州网) on 5 December 2025
* Tier: 2
...
* Value: a guest with a confirmed booking at a property inside the scenic area plus a parking reservation (停车预约) may drive in at any time; on quiet weekdays staff may relax the cut off to 15:00, weekends and holidays run 08:00 to 17:30 in full
* As of: December 2025
* Source: Tide News (潮新闻)
* Tier: 2
* URL: https://tidenews.com.cn/news.html?id=3315585
* Verified 1: 2026-09-06 (停车预约 and 15:00 wording confirmed on page)
* Verified 2: 2026-09-06 (fetched again, present)
* Shelf life: volatile, 3 months
* Used in: private-car-ban-on-moganshan
* Notes: the report does not say how the reservation is made. A per car entry charge (RMB 20 in forum posts and content farm pieces) could not be sourced at any tier and is not used. Same source gives the reporters stopped near 林海亭, 5.8 km from the entrance, on 3 December 2025.

### Shuttle hours at the Houwu transfer point
* Value: 08:30 to 17:00, last bus up 16:30, last bus down 17:00, departs when full or every 30 minutes
* As of: December 2025
* Source: Tide News (潮新闻)
* Tier: 2
* URL: https://tidenews.com.cn/news.html?id=3315585
...
* Value: 500 outdoor parking spaces at the Yucun centre; shuttle RMB 35 per person return, RMB 18 single down; rule from 30 November 2018
* As of: December 2018
* Source: Deqing Culture and Tourism (德清文旅), reproduced on 163.com
* Tier: 4 (announced; cite only as what was announced at launch)
...
* Value: free up to 30 minutes; RMB 10 for 30 minutes to 5 hours; RMB 15 for 5 to 10 hours; RMB 20 for 10 to 15 hours; RMB 25 over 15 hours; Houwu parking free
* As of: July 2019, repeated September 2025
* Source: Sohu Travel (搜狐旅游, 权哥探店); repeated by Autohome (汽车之家) Q and A dated 22 September 2025
* Tier: 3 (reported, no tier 1 or 2 source reachable)
* URL: https://www.sohu.com/a/324235488_357973 and https://www.autohome.com.cn/ask/18981801.html
...
* Value: 07:00 to 17:00
* As of: September 2025
* Source: Autohome (汽车之家)
* Tier: 3
* URL: https://www.autohome.com.cn/ask/18981801.html
* Verified 1: 2026-09-06
* Verified 2: 2026-09-06
* Shelf life: volatile, 3 months
* Used in: private-car-ban-on-moganshan
...
<!-- Desk research only: nobody walks a route or rings a number. One entry
