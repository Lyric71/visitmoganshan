...
seo_title: "Moganshan Yellow Bud Tea: Huangya, and Where to Drink It"
meta_description: Moganshan huangya is a yellow tea, a class of its own. What yellow tea is, what this mountain can grow, when it is picked, and where to drink it.
excerpt: Moganshan's tea is huangya, a yellow bud tea. Yellow is a class of its own, with a step in it green tea never gets. What that means, what this mountain can actually grow, and how to find a cup.
...
That is the class. Now this mountain's version of it.
...
Type huangya into a search box on its own and Anhui usually answers first.

Bud is the other half of the name, and it describes the pick rather than the taste. Unopened buds, or a bud with one small leaf attached, instead of mature leaf. That is the top of the ladder in this style, and it is why bud teas cost what they do. A picker fills a basket slowly. So the phrase is not marketing. It names a processing route and a pick.
...
Tea gets poured here in every month. What the season changes is whether the cup in front of you is this year's leaf.

![A picker working a row of tea at first light, basket at the hip, taking only the top buds](/images/guide/tea-3.webp 'Spring picking is measured in weeks, not months, and it moves with the weather rather than the date.')
...
So ask. Five questions, most useful first.

| Ask | Why it matters |
|---|---|
| Is this local tea? 这是本地茶吗？ | Guesthouse tea is whatever the owner buys, not always from this mountain |
| Is it Mogan huangya? 这是莫干黄芽吗？ | The claim worth testing, and the reason you are asking at all |
| Which year is it? | Spring bud tea is dated. Last year's is a different thing at a different price |
| Where do you buy it? | The question that finds you a shop, and the one nobody asks |
| Can you write the name down? | So you can show it at a counter instead of pronouncing it |

If the answer to the first two is no, that is useful rather than a failure. The cup in your hand is ordinary Chinese tea, poured because pouring tea is what a host does.
...
|---|---|
| Net weight | Printed in grams on the pack, so you can divide the price by it |
| Harvest year | Stated on the pack. Spring tea is dated |
...
|---|---|---|---|---|
| /images/guide/moganshan-tea.webp | 16:9 | Establishing shot. Rows of low, clipped tea bushes running across a slope in the foreground and middle distance, with dense moso bamboo rising on the ridge behind them so both crops sit in one frame. Overcast or early morning light with mist on the ridge, not golden hour. The point of the frame is that tea here is a small crop inside a bamboo mountain, so the bamboo should visibly dominate the background. | Rows of low tea bushes on a Moganshan slope with moso bamboo standing on the ridge above them | Lead image, no caption |
| /images/guide/tea-2.webp | 3:2 | Close, waist height, along a row of tea. Pale new buds and the first small leaf standing above darker mature leaf, sharp enough to count. Wet from mist or light rain preferred. No hands, no basket, no people in this one. | Rows of tea bushes on a terraced slope at Moganshan, with new buds showing pale against the darker mature leaf | A bud tea is picked from the top few centimeters of the bush. Everything below that line is a cheaper product from the same plant. |
| /images/guide/tea-3.webp | 3:2 | A picker at work in a row, early light, wicker or woven basket at the hip or on the back, one hand in the bush taking the top growth. Working clothes, not costume. Shoulders and hands are the subject; a face is optional and should not be posed. | A picker working a row of tea at first light, basket at the hip, taking only the top buds | Spring picking is measured in weeks, not months, and it moves with the weather rather than the date. |
| /images/guide/tea-4.webp | 3:2 | A tall clear glass of pale gold tea on a wooden guesthouse table, leaf suspended in the water, a thermos or kettle beside it and a window or veranda with bamboo visible beyond. Daylight. Deliberately not a formal gongfu tea set, because that is not how a guesthouse pours it. | A glass of pale gold yellow tea on a guesthouse table at Moganshan, leaf still in the water | Water off the boil rather than on it. Bud teas scorch at 100 °C, which is the single most common mistake made with them outside China. |
