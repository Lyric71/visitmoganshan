---
url: /journal/the-second-opening/
title: The second opening
seo_title: "Moganshan and Mark Kitto: The Mountain's Second Opening"
meta_description: Foreigners reopened Moganshan after 2003 and named a category after themselves. The domestic guesthouse boom that followed took it away from them.
excerpt: Moganshan was opened to foreigners twice. The second time foreigners did the opening themselves, selling rooms to Chinese guests, and the trade they started is no longer theirs. The word for it still is.
primary_keyword: moganshan mark kitto
secondary_keywords: [naked retreats moganshan, moganshan yangjiale, moganshan minsu boom]
schema: Article
...
Four years after that, naked Stables put a certificate on the model and a price band under it. [It runs about 121 keys](/where-to-stay/hotels/naked-stables/), and naked Retreats, the group Horsfield built around it, later took naked Castle into a villa a Scottish physician-missionary named Maitland put up in 1910. In that one case, the second opening moved into the first opening's buildings literally.

Sanjiuwu itself is small, and most visitors drive through without noticing that anything started there. [The villages page](/moganshan/villages/) sets it beside the others.

![Renovated village house working as a guesthouse at Moganshan](/images/guide/journal-second-2.webp 'The model was ordinary village housing let as rooms. Mid-range guesthouses here still run RMB 300 to 500 out of season and pass RMB 1,000 at peak.')
...
TODO: verify how many Moganshan properties are foreign-owned or foreign-run today. The research holds the 18-country figure and the list of nationalities, and no count. Until that closes, "foreigners no longer dominate" rests on the ownership share and not on a direct number.
...
![Guesthouse signage in a Moganshan village street](/images/guide/journal-second-3.webp 'Local government capped bed capacity at about 10,000 in late 2017 and tightened approvals. Actual stock has drifted above the cap since.')
...
TODO: verify what else drove the timing. No policy paper or land-use decision in our research is dated to the years the count climbed fastest, so whether the state pushed this, followed it or simply allowed it is not something we can say.
...
Chinese reporting keeps returning to one more problem, and English-language coverage almost never picks it up. The villages have no evening economy. There is no night market and little food once the guesthouse kitchens close, which leaves a guest with nowhere to spend anything after dinner. [Where to stay](/where-to-stay/) sets out what that means for a two-night trip.

![Quiet village street at Moganshan after dark](/images/guide/journal-second-4.webp 'Golden Week inverts it. High-end guesthouse occupancy hit 94 percent over the May 2024 holiday, against about 55 percent across the year.')
...
TODO: verify the current status and closing date of Moganshan Lodge.
...
*Figures follow the fact base compiled 1 to 5 August 2026, last checked 7 August 2026. Guesthouse counts, occupancy and payback periods move; the three TODO markers above stay until the research closes them.*
...
|---|---|---|---|---|
| /images/guide/journal-second-opening.webp | 16:9 | A cluster of village guesthouses at the foot of the mountain, bamboo slopes rising behind them. Shoot from a public road or a rise, late afternoon. The subject is the scale of the trade rather than one property. Do not feature a single identifiable brand. | Village guesthouses below the bamboo slopes of Moganshan, the trade that grew from the first foreign-run farmstay | Lead image, no caption |
| /images/guide/journal-second-2.webp | 3:2 | A renovated village house working as a guesthouse: old structure, new glazing or a new terrace, seen from the street. Sanjiuwu preferred. No interiors, no guests in frame, no signage that names a brand. | Renovated village house working as a guesthouse at Moganshan | The model was ordinary village housing let as rooms. Mid-range guesthouses here still run RMB 300 to 500 out of season and pass RMB 1,000 at peak. |
| /images/guide/journal-second-3.webp | 3:2 | A village street in Xiantan with several guesthouse signs visible at once, showing density. Chinese signage in frame is the point. Shoot flat light so the signs read. Blur or avoid faces and vehicle plates. | Guesthouse signage in a Moganshan village street | Local government capped bed capacity at about 10,000 in late 2017 and tightened approvals. Actual stock has drifted above the cap since. |
| /images/guide/journal-second-4.webp | 3:2 | The same kind of village street after dark, lit only by house windows and a street lamp, nothing open. The subject is the absent evening economy. No people, no flash. | Quiet village street at Moganshan after dark | Golden Week inverts it. High-end guesthouse occupancy hit 94 percent over the May 2024 holiday, against about 55 percent across the year. |
