...
If you use a wheelchair, or you can walk but not far, the question about Moganshan is not whether it is worth seeing. It is whether you get past the transfer center at the bottom.
...
Start with the part that is most likely to work.
...
The private-vehicle rule decides this trip more than the gradient does. No private car goes inside the scenic area. Everyone changes at one of three transfer centers, Yucun, Fatou or Houwu, and all three run 08:00 to 18:00.
...
## The scenic area and the named sights
...
| Send exactly this | What a vague answer means |
|---|---|
| How many steps from where a car stops to your front door? | "Only a few" means nobody counted them |
| Is there a bedroom on the ground floor, with no steps to the door? | Anything other than yes is a no |
| How wide is the bathroom door, in centimeters? | A house that has measured has thought about this before. One that has not says the bathroom is big |
| Do you step over anything to get into the shower? | "A normal shower" says nothing about the tray lip |
| Can a car reach your door? If not, how far is the walk, in meters? | An answer that skips the distance means it is longer than you want |
| Which transfer center serves you, and can someone meet us there? | They field this one weekly. A fluent answer means the rest are worth trusting |
| Do you cook dinner at the property? | Book it for the arrival night. Most villages have no second option after dark |

Then ask for two photographs: the entrance seen from the road, and the bathroom. A picture settles in ten seconds what messages will not settle at all, and it arrives while the booking can still be changed. [Where to stay](/where-to-stay/) covers the choice on every other ground.

![The entrance of a converted village guesthouse at Moganshan, with two stone steps up from the lane to the door](/images/guide/accessibility-4.webp 'Two steps and a raised threshold is an ordinary entrance here, and no listing photograph shows it. Ask for this shot before you pay.')

## With a stroller, which is a different problem
...
|---|---|---|---|---|
| /images/guide/plan-accessibility.webp | 16:9 | A stone lane climbing between village houses at the foot of Moganshan. The frame has to show the gradient honestly: a shallow flight of steps where the slope steepens, uneven paving joints, no handrail. Flat overcast daylight, no people, no golden hour. A documentary frame, not a scenic one. | A stone lane climbing between village houses at the foot of Moganshan, with a shallow flight of steps where the slope steepens | Lead image, no caption |
| /images/guide/accessibility-2.webp | 3:2 | The Yucun transfer center with scenic-area vehicles waiting at the boarding bays. The vehicles are the subject, shot square-on so the floor height, the door width and any step are all readable. Include the ground at the vehicle door. Do not crop the wheels out. | The Yucun transfer center at the foot of Moganshan, with scenic-area vehicles waiting at the boarding bays | Published so you can judge the boarding height yourself. We have not confirmed what these vehicles are or how anyone gets on them. |
| /images/guide/accessibility-3.webp | 3:2 | A village lane at ground level, shot low so the surface fills the lower half of the frame. Laid stone with visible joints, a change of paving material, and a short flight of steps where the gradient turns. No people. The subject is the ground, not the village. | A stone lane in a Moganshan village, with the paving change and a short flight of steps where the slope steepens | Laid stone, uneven joints and a step where the gradient turns. The standard surface here, not the difficult end of it. |
| /images/guide/accessibility-4.webp | 3:2 | The entrance of a converted village guesthouse, shot from the lane at standing height. Two stone steps up to the door and a raised threshold at the door itself, both clearly readable. An ordinary property, not the smartest one available. | The entrance of a converted village guesthouse at Moganshan, with two stone steps up from the lane to the door | Two steps and a raised threshold is an ordinary entrance here, and no listing photograph shows it. Ask for this shot before you pay. |
