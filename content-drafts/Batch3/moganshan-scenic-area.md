...
Deqing County, in Huzhou prefecture, Zhejiang Province, is where you find Moganshan: a mountain 60 km north of Hangzhou. Shanghai is 200 to 240 km from it. The protected part of the mountain is the Moganshan National Scenic Area, and it is smaller than people expect.

The layout is what trips people up. The villages, and almost all of the roughly 1,000 guesthouses, sit outside the ticketed area. So do most restaurants. You do not stay inside the scenic area. You go in for part of a day, come back out for dinner, and the last transfer leaves earlier than you expect.

If you are here after Moganshan Road, that is the M50 art district in Shanghai, which the [what and where Moganshan is](/moganshan/) page sorts out.

## Three designations, one mountain

Three official labels sit on the same mountain.
...
> Designations and the 15 December 2020 resort listing, BeyondBorder Group Ltd primary research, 1 to 5 August 2026.

## How big the scenic area is

| Measure | Figure |
|---|---|
| Core scenic area | About 20 km². Some sources quote 43 km² for a wider designated area |
...
Moganshan Town and the scenic area are not the same thing. The town covers the foot of the mountain, with the villages and the guesthouses in it. The scenic area is the ticketed core above. Most of your trip happens below the gate.

The split below decides where your day happens.

| Inside the ticketed core | Outside it |
|---|---|
| Sword Pond (Jianchi) | Yucun, the main village at the foot: square, market, 1932 culture park |
| Luhuadang Park | Xiantan, the guesthouse village on the north side, about 135 minsu |
...
TODO: verify how many of the roughly 250 surviving historic villas sit inside the boundary.
...
TODO: verify whether a named gate list exists separate from the three transfer centers, and whether walking in on foot is allowed outside transfer hours. No public source settles it.
...
TODO: verify child, student and senior concessions. Neither range breaks them out.
...
Luhuadang Park and Dakeng put you deep in the bamboo, and Xuguang is the sunrise viewpoint. [Things to do](/things-to-do/) covers the wider list, most of it outside the gate.

## When to go, and how busy it gets

Summer is the historic season and still the main one. Moganshan is counted traditionally as one of China's four great summer resorts, with Beidaihe, Lushan and Jigongshan.

| Time of year | Up on the ridge | At the gate |
|---|---|---|
