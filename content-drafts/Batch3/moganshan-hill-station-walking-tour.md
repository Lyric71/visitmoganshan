...
About 250 historic villas survive on these slopes, built from local mountain stone. This page takes six of them and puts them in an order that reads as one story. If the mountain is new to you, [the Moganshan hill station](/moganshan/hill-station/) is the short version, [the longer history](/moganshan/hill-station/history/) has the dates and the disputes, and [the villas of Moganshan](/moganshan/hill-station/the-villas/) takes the buildings one by one.

The slopes belong to Moganshan, in Deqing County, in Huzhou prefecture, Zhejiang Province, 60 km north of Hangzhou and a 200 to 240 km run from Shanghai. The main peak, Tashan, is 719 to 720 meters high. If a search engine sent you to an art district, that was Moganshan Road in Shanghai's Putuo District, about 200 km from here and no relation.
...
Our field check is scheduled, and anything unverified is marked `TODO: verify on the ground` until it happens. A made-up map would be worse than an honest gap. If you want turn-by-turn directions today, ask your guesthouse. Staff walk this mountain every week.
...
**Food.** Yucun (庾村), the main village at the foot, has a square, a market and restaurants. Chinese reporting notes the villages have almost no evening economy: no night market, little late-night food. Eat when food is in front of you.

Weekends and the May and October Golden Weeks are heavy. High-end guesthouse occupancy hit 94 percent over the May 2024 holiday. Mondays are notably quiet.

## The six stops

| # | Stop | Built or dated | Why it is on this list | Access |
|---|---|---|---|---|
| 1 | Songyue Lodge, Wuling village | Standing by December 1927 | Chiang Kai-shek's honeymoon villa; currency-reform meetings in 1948 | TODO: verify on the ground |
| 2 | Baiyun Shanguan | Owned by Huang Fu | 1937 secret talks between the Nationalists and the Communists | TODO: verify on the ground |
| 3 | The former Empress Hotel | 1934 | Built by banker Jiang Yizhe; Mao Zedong stayed in 1954 | TODO: verify on the ground |
| 4 | The Du Yuesheng and Zhang Xiaolin villa | 1935 | Built by two Green Gang bosses, ornate Chinese style | TODO: verify on the ground |
| 5 | Maitland's castle villa, now naked Castle | 1910 | Scottish physician-missionary; English castle style; a working hotel | Hotel guests and bookings only. TODO: verify outside viewing |
| 6 | The assembly hall | Used in 1984 | Venue of the Moganshan Conference of reform economists | TODO: verify on the ground |

Distances, walking times and opening hours for every stop: TODO: verify on the ground.
...
*Leg to stop 2, plus access and hours: TODO: verify on the ground.*
...
The owner was not a party man. Huang Fu was a Republican diplomat and former acting premier, and his house was neutral ground both sides could accept.

It is the same man as stop 1, ten years on, with a very different set of people across the table.

*Leg to stop 3, plus access and hours: TODO: verify on the ground.*
...
*Leg to stop 4, plus access and hours: TODO: verify on the ground.*
...
*Leg to stop 5, plus access and hours: TODO: verify on the ground.*

## Stop 5: Maitland's castle villa, now naked Castle

A Scottish physician and missionary named Maitland built a villa in the style of an English castle in 1910. It was restored much later and now operates as naked Castle, a hotel of about 95 keys that opened in 2017.

The date is the interesting part. By 1910 about 300 foreigners held summer homes here, most of them American and British. They had run their own association since 1898 and built a tennis court in 1901. This was a functioning summer town, not a cluster of cabins.
...
Keon's argument is that Moganshan existed so foreign families could raise foreign children away from Chinese cities. A castle built by a Scottish doctor fits that reading.
...
*Leg to stop 6, plus outside viewing: TODO: verify on the ground.*
...
*Access and hours: TODO: verify on the ground.*
